"""
Python 3.12.10 Final Compatibility & Real-User Test for Command Nexus.
Mocks blocking dialogs; tests all code paths.
"""
...
print('=' * 70)
print('PYTHON 3.12.10 FINAL COMPATIBILITY & REAL-USER TEST')
...
ok("Approval gate mocked (non-blocking)")
...
# ====================================================================
# SCENARIO 3: Visibility mission lifecycle (WITH deployed AI + mocked approval)
# ====================================================================
print('\n--- Scenario 3: Visibility Mission ---')
try:
    v = cna._visibility
    
    # Select AI in dropdown
    ...
    # Start mission 2 and simulate completion
    ...
    v._on_mission_tick()
    final_status = session.current_task.status.value if session.current_task else 'none'
    ok(f"Tick 3 (complete): status={final_status}")
...
# ====================================================================
# SCENARIO 13: License validation
# ====================================================================
print('\n--- Scenario 13: License ---')
try:
    ...
    ok(f"AI limit: {lm.get_ai_limit()}")
    
    s, m = lm.validate_key("BAD-KEY")
