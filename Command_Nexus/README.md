...
Dependencies: `PyQt6>=6.6.0`, `mss>=9.0.0`, `psutil>=5.9.0`
...
A PyQt6 desktop application with 5 integrated parts: Visibility Window (command center), AI Forge (builder/registry), The Book (per-AI knowledge), Upgrades (capability modules), and The Watcher (background defense).
