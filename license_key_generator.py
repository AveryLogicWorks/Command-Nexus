...
TIER_CODES: dict[SubscriptionTier, str] = {
    ...
    SubscriptionTier.TRIAL_ENTERPRISE: "TE",
    SubscriptionTier.STARTER: "ST",
    SubscriptionTier.PRO: "PR",
    SubscriptionTier.BUSINESS: "BU",
    SubscriptionTier.UNLIMITED: "UN",
    SubscriptionTier.ENTERPRISE_PROPERTY: "EP",
    SubscriptionTier.ENTERPRISE_CORPORATE: "EC",
}

# Human pricing info for output
TIER_PRICING = {
    SubscriptionTier.TRIAL:               {"price": "$10",              "duration": "15 days",  "ais": 1},
    SubscriptionTier.TRIAL_ENTERPRISE:    {"price": "Free Eval",        "duration": "15 days",  "ais": "unlimited"},
    SubscriptionTier.STARTER:             {"price": "$30/mo",           "duration": "30 days",  "ais": 2},
    SubscriptionTier.PRO:                 {"price": "$50/mo",           "duration": "30 days",  "ais": 4},
    SubscriptionTier.BUSINESS:            {"price": "$80/mo",           "duration": "30 days",  "ais": 5},
    SubscriptionTier.UNLIMITED:           {"price": "$120/mo",          "duration": "30 days",  "ais": "unlimited"},
    SubscriptionTier.ENTERPRISE_PROPERTY: {"price": "$2,500–$10,000",   "duration": "negotiated","ais": "unlimited"},
    SubscriptionTier.ENTERPRISE_CORPORATE:{"price": "$10,000–$25,000",  "duration": "negotiated","ais": "unlimited"},
}
