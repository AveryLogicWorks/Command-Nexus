...
CAPABILITY_QUICK_START: dict[str, dict] = {
    ...
    # ── Phase 6: Wellness & Content ──
    "Wellness Coach": {"emoji": "\U0001F34F", "color": "#2ea043", "title": "Wellness Helper", "question": "What wellness goal do you have?", "examples": ["Create a beginner fitness plan", "Suggest healthy meals", "Help me manage stress", "Build a morning routine"]},
    "Content Strategist": {"emoji": "\U0001F4C5", "color": "#8957e5", "title": "Content Planner", "question": "What content do you need to plan?", "examples": ["Build a content calendar", "Analyze my audience", "Repurpose this blog post", "Define my brand voice"]},

    # ── Phase 7: New Capabilities ──
    "Task Scheduler": {"emoji": "\u23f0\ufe0f", "color": "#1a73e8", "title": "Schedule It", "question": "What do you need scheduled?", "examples": ["Plan my week", "Block time for deep work", "Set reminders", "Schedule appointments"]},
    "Report Generator": {"emoji": "\U0001F4CB", "color": "#0d6efd", "title": "Make a Report", "question": "What kind of report do you need?", "examples": ["Generate a monthly report", "Create a status update", "Make a project summary", "Format a business report"]},
    "Invoice Processor": {"emoji": "\U0001F9FE", "color": "#2ea043", "title": "Create Invoice", "question": "What do you need invoiced?", "examples": ["Create a service invoice", "Calculate tax and totals", "Format a payment request", "Add payment terms"]},
    "Spreadsheet Analyst": {"emoji": "\U0001F4CA", "color": "#0d6efd", "title": "Spreadsheet Help", "question": "What spreadsheet help do you need?", "examples": ["Help with a VLOOKUP", "Create a pivot table", "Fix this formula", "Analyze this data"]},
    "Data Visualizer": {"emoji": "\U0001F4C8", "color": "#0d6efd", "title": "Visualize Data", "question": "What data do you want to visualize?", "examples": ["Recommend charts for my data", "Visualize sales trends", "Create a bar chart", "Show this data visually"]},
    "Statistical Modeler": {"emoji": "\U0001F4D0", "color": "#0d6efd", "title": "Stats Helper", "question": "What statistical analysis do you need?", "examples": ["Run a regression analysis", "Test for significant differences", "Calculate confidence intervals", "Which statistical test should I use?"]},
    "Trend Forecaster": {"emoji": "\U0001F52C", "color": "#0d6efd", "title": "Forecast Trends", "question": "What do you want to forecast?", "examples": ["Forecast next quarter revenue", "Predict seasonal trends", "Project growth", "Analyze time series data"]},
    "DevOps Assistant": {"emoji": "\U0001F6E0\ufe0f", "color": "#2ea043", "title": "DevOps Helper", "question": "What DevOps help do you need?", "examples": ["Set up a CI/CD pipeline", "Write a Dockerfile", "Configure Kubernetes", "Plan a deployment strategy"]},
    "Database Manager": {"emoji": "\U0001F5C4\ufe0f", "color": "#2ea043", "title": "Database Helper", "question": "What database help do you need?", "examples": ["Design a database schema", "Optimize a slow query", "Plan a migration", "Write SQL queries"]},
    "Test Generator": {"emoji": "\u2705", "color": "#2ea043", "title": "Generate Tests", "question": "What code do you need tests for?", "examples": ["Generate unit tests", "Write integration tests", "Create edge case tests", "Outline test coverage"]},
    "Documentation Generator": {"emoji": "\U0001F4D8", "color": "#6e7681", "title": "Generate Docs", "question": "What documentation do you need?", "examples": ["Generate API docs", "Create a README", "Write user guides", "Document this code"]},
    "Script Writer": {"emoji": "\U0001F4BB", "color": "#2ea043", "title": "Write a Script", "question": "What script do you need?", "examples": ["Write a batch rename script", "Create a backup script", "Automate this task", "Write a PowerShell script"]},
    "Copy Editor": {"emoji": "\u270f\ufe0f", "color": "#8957e5", "title": "Edit My Text", "question": "What text do you want edited?", "examples": ["Check grammar and style", "Edit for clarity", "Proofread this", "Improve this tone"]},
    "Podcast Planner": {"emoji": "\U0001F3A4", "color": "#8957e5", "title": "Plan a Podcast", "question": "What podcast do you want to plan?", "examples": ["Plan an episode", "Create show notes", "Structure a season", "Suggest podcast topics"]},
    "Brand Strategist": {"emoji": "\U0001F3ED", "color": "#f0883e", "title": "Brand Helper", "question": "What do you need for your brand?", "examples": ["Develop a brand identity", "Create a positioning statement", "Define brand values", "Analyze my brand"]},
    "Presentation Coach": {"emoji": "\U0001F4A1", "color": "#8957e5", "title": "Coach My Talk", "question": "What presentation do you need help with?", "examples": ["Structure my presentation", "Create talking points", "Coach my delivery", "Review my slides"]},
    "PR Assistant": {"emoji": "\U0001F4F0", "color": "#f0883e", "title": "PR Helper", "question": "What PR content do you need?", "examples": ["Write a press release", "Craft a media pitch", "Draft a crisis response", "Create a PR strategy"]},
    "Internal Comms Writer": {"emoji": "\U0001F4E7", "color": "#1a73e8", "title": "Internal Comms", "question": "What internal message do you need?", "examples": ["Write a company announcement", "Draft a team update", "Create a change message", "Write an employee newsletter"]},
    "Academic Citation Manager": {"emoji": "\U0001F4DA", "color": "#0d6efd", "title": "Format Citations", "question": "What citations do you need?", "examples": ["Format citations in APA", "Create a bibliography", "Convert MLA to Chicago", "Format my reference list"]},
    "Patent Researcher": {"emoji": "\U0001F4DC", "color": "#f0883e", "title": "Patent Search", "question": "What do you want to research?", "examples": ["Search for prior art", "Analyze patent claims", "Guide my patent search", "Find similar patents"]},
    "Market Analyst": {"emoji": "\U0001F4CA", "color": "#f0883e", "title": "Market Analysis", "question": "What market do you want to analyze?", "examples": ["Analyze the SaaS market", "Identify competitors", "Assess market size", "Find market opportunities"]},
    "Recipe Planner": {"emoji": "\U0001F373", "color": "#2ea043", "title": "Plan Meals", "question": "What meals do you need?", "examples": ["Plan 5 dinners", "Suggest vegetarian meals", "Create a meal prep plan", "What should I cook this week?"]},
    "Travel Planner": {"emoji": "\u2708\ufe0f", "color": "#1a73e8", "title": "Plan a Trip", "question": "Where do you want to go?", "examples": ["Plan a 7-day trip", "Create a weekend itinerary", "Suggest budget travel options", "Plan activities for my trip"]},
    "Event Planner": {"emoji": "\U0001F389", "color": "#f0883e", "title": "Plan an Event", "question": "What event are you planning?", "examples": ["Plan a conference", "Organize a party", "Create an event timeline", "Build an event checklist"]},
    "Personal Finance Manager": {"emoji": "\U0001F4B0", "color": "#2ea043", "title": "Finance Helper", "question": "What financial help do you need?", "examples": ["Create a monthly budget", "Plan debt repayment", "Set savings goals", "Track my expenses"]},
    "Privacy Compliance Checker": {"emoji": "\U0001F512", "color": "#f0883e", "title": "Privacy Check", "question": "What compliance do you need to check?", "examples": ["Check GDPR compliance", "Review my privacy policy", "Assess CCPA requirements", "Audit data handling"]},
    "Data Governance Advisor": {"emoji": "\U0001F3DB\ufe0f", "color": "#0d6efd", "title": "Data Governance", "question": "What governance do you need?", "examples": ["Design a governance framework", "Create data quality metrics", "Define stewardship roles", "Establish data policies"]},
    "Curriculum Designer": {"emoji": "\U0001F393", "color": "#0d6efd", "title": "Design a Course", "question": "What curriculum do you need?", "examples": ["Design a Python course", "Create a training program", "Build a lesson plan", "Structure learning modules"]},
    "Exam Prep Coach": {"emoji": "\U0001F4DD", "color": "#0d6efd", "title": "Exam Prep", "question": "What exam are you preparing for?", "examples": ["Create a study plan", "Suggest practice strategies", "Prepare for the SAT", "Build a test schedule"]},
}
