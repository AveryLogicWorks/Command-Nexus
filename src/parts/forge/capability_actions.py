...
ALL_USE_CASES = ["Individual", "Educational", "Task-Ready", "Business", "Enterprise", "Financial Gainer", "Memory Saver", "Gaming", "Developer/Creator", "Health & Wellness", "Creative Studio", "All-Rounder"]
...
CAPABILITY_REGISTRY: dict[str, CapabilityAction] = {
    ...
    "Coder": _action(
        ...
        ["Individual", "Task-Ready", "Enterprise", "Developer/Creator", "All-Rounder"], ["Chatbot", "Research", "Document Processor", "Tool User"],
    ...
    "Creative Writing": _action(
        ...
        ["Individual", "Educational", "Business", "Enterprise", "Developer/Creator", "Creative Studio", "All-Rounder"], ["Chatbot", "Research", "Planner", "Archive", "Hephaestus Relay"],
    ...
    "Document Processor": _action(
        ...
        ["Individual", "Educational", "Task-Ready", "Business", "Enterprise", "Developer/Creator", "All-Rounder"], ["Research", "Planner", "Notebook", "Archive", "Business Workflow"],
    ...
    "Tool User": _action(
        ...
        ["Task-Ready", "Business", "Enterprise", "Gaming", "Developer/Creator", "Health & Wellness", "Creative Studio", "All-Rounder"], ["Planner", "Coder", "Research", "Business Workflow"],
    ...
    "Customer Support AI": _action(
        ...
        "CustomerSupportDialog", "Open Customer Support",
    ),
    ...
    "Visual Canvas": _action(
        ...
        ["Individual", "Educational", "Business", "Enterprise", "Gaming", "Creative Studio", "All-Rounder"],
    ...
    "Data Analyst Pro": _action(
        ...
        ["Business", "Enterprise", "Health & Wellness", "All-Rounder"],
    ...
    "Code Reviewer": _action(
        ...
        ["Individual", "Task-Ready", "Enterprise", "Developer/Creator", "All-Rounder"],
    ...
    "API Integrator": _action(
        ...
        ["Business", "Enterprise", "Developer/Creator", "All-Rounder"],
    ...
    "Knowledge Base Builder": _action(
        ...
        ["Business", "Enterprise", "Developer/Creator", "Creative Studio", "All-Rounder"],
    ...
    "Calendar Manager": _action(
        ...
        ["Individual", "Business", "Enterprise", "Health & Wellness", "All-Rounder"],
    ...
    "Document Generator": _action(
        ...
        ["Individual", "Educational", "Business", "Enterprise", "Creative Studio", "All-Rounder"],
    ...
    "Presentation Builder": _action(
        ...
        ["Individual", "Educational", "Business", "Enterprise", "Developer/Creator", "Creative Studio", "All-Rounder"],
    ...
    "Game Companion": _action(
        ...
        "Learns and plays games alongside the user as a P2 co-op partner or opponent. Features playstyle selection (defensive, decoy, cooperative team, solo aggressor, secret finder, support, balanced), adaptive learning that improves over repeated sessions, game rules teaching, strategy advising, position analysis, practice drills, and progress tracking. Designed for PC co-op, board games, card games, and cognitive skill building.",
        "Game companion workspace with game selector, rules learner, strategy advisor, position analyzer, practice mode, progress tracker, P2 co-op partner mode with playstyle selection, and adaptive learning engine that tracks patterns and improves over time.",
        "No outward actions. All game analysis, co-op suggestions, and playstyle adaptations are local and advisory. No in-game automation or direct game API integration.",
        [], "None",
        ["Individual", "Educational", "Gaming", "Creative Studio", "All-Rounder"],
        ["Chatbot", "Tutor", "Research", "Memory Recorder", "Activity Watcher"],
        [
            "Teach game rules clearly before suggesting strategy.",
            "Adapt suggestions to the user's skill level and chosen playstyle.",
            ...
            "In co-op mode, communicate intentions clearly and coordinate with the player.",
            "Learn from each session — track what worked, what didn't, and adapt future play.",
            "Respect the player's chosen playstyle but suggest alternatives when beneficial.",
        ],
        ["Capability Attachments", "Operating Context", "Cross-Capability Workflows"],
        ["Game Strategy Library", "Cognitive Skills Library", "Communication Library", "Adaptive Learning Library"],
        [
            ...
            "Be my P2 co-op partner — play defensively",
            "Switch to aggressive solo mode for this round",
            "What have you learned from our previous games?",
            "Act as a decoy while I flank the enemy",
        ],
        "Game companion discussion, co-op play guidance, and strategy work locally; live game API integration is not connected. Learning is session-based with optional persistence.",
        "GameCompanionDialog", "Open Game Companion",
    ),
    "Wellness Coach": _action(
        "cap.wellness", "Wellness Coach",
        "Fitness planning, nutrition guidance, mental wellness support, habit building, and progress tracking. Advisory only — not a medical professional.",
        "Wellness workspace with fitness planner, nutrition advisor, mental wellness guide, habit builder, and progress tracker.",
        "No outward actions. All wellness guidance is local and advisory.",
        [], "None",
        ["Individual", "Health & Wellness", "All-Rounder"],
        ["Chatbot", "Tutor", "Planner", "Notebook", "Activity Watcher"],
        [
            "Always clarify this is advisory, not medical advice.",
            "Encourage consulting healthcare professionals for medical concerns.",
            "Adapt recommendations to the user's fitness level and limitations.",
            "Never prescribe medication or diagnose conditions.",
            "Promote sustainable habits over extreme measures.",
        ],
        ["Capability Attachments", "Operating Context"],
        ["Communication Library", "Project Memory Library"],
        [
        ...
        "Wellness guidance is local and advisory; no medical systems are connected.",
        "WellnessCoachDialog", "Open Wellness Coach",
    ),
    "Content Strategist": _action(
        "cap.content_strategy", "Content Strategist",
        "Content calendar planning, audience analysis, platform optimization, content repurposing, and brand voice development.",
        "Content strategy workspace with calendar planner, audience analyzer, platform optimizer, repurposing engine, and brand voice tuner.",
        "Publishing, scheduling, or social media automation require approval.",
        ["outbound messages", "export", "file_write"], "Medium",
        ["Business", "Creative Studio", "Developer/Creator", "All-Rounder"],
        ["Creative Writing", "Marketing Generator", "Research", "Document Processor", "Social Media Manager"],
        [
            "Always match content to platform norms and audience expectations.",
            "Repurpose rather than duplicate — adapt for each platform.",
            "Flag claims that need sourcing before publishing.",
            "Maintain consistent brand voice across channels.",
            "Do not publish or schedule without approval.",
        ],
        ["Capability Attachments", "Cross-Capability Workflows", "Common Prompts"],
        ["Communication Library", "Research Discipline Library", "Project Memory Library"],
        [
            "Build a content calendar for this month",
            "Analyze my target audience",
            "Repurpose this blog post for social media",
            "Define my brand voice",
        ],
        "Content strategy is local; publishing and scheduling automation are not connected.",
        "ContentStrategistDialog", "Open Content Strategist",
    ),

    "Task Scheduler": _action(
        "cap.task_scheduler", "Task Scheduler",
        "Scheduling, time blocking, reminders, and appointment planning.",
        "Task scheduling workspace with input, plan generation, and output.",
        "Calendar modifications and external scheduling require approval.",
        ["calendar_access"], "Low",
        ALL_USE_CASES, ["Chatbot", "Planner"],
        ["Suggest times only; do not auto-schedule.", "Respect timezone preferences."],
        ["Capability Attachments", "Common Prompts"],
        ["Project Memory Library"],
        ["Schedule my week", "Block time for deep work", "Set reminders for deadlines"],
        "Scheduling suggestions are local; calendar integration is not connected.",
        "TaskSchedulerDialog", "Open Task Scheduler",
    ),
    "Form Builder": _action(
        "cap.form_builder", "Form Builder",
        "Create forms, surveys, and questionnaires with appropriate question types.",
        "Form building workspace with input, design generation, and output.",
        "Form publishing and data collection require approval.",
        ["export"], "Low",
        ALL_USE_CASES, ["Document Processor", "Research"],
        ["Keep forms concise.", "Use appropriate question types."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Create a customer survey", "Design a registration form"],
        "Form design is local; form hosting and data collection are not connected.",
        "FormBuilderDialog", "Open Form Builder",
    ),
    "Report Generator": _action(
        "cap.report_generator", "Report Generator",
        "Generate structured reports from data and context.",
        "Report generation workspace with input, report generation, and output.",
        "Report distribution requires approval.",
        ["export", "file_write"], "Low",
        ALL_USE_CASES, ["Research", "Data Visualizer", "Spreadsheet Analyst"],
        ["Structure reports clearly.", "Cite data sources."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library", "Project Memory Library"],
        ["Generate a monthly report", "Create a project status update"],
        "Report generation is local; distribution is not connected.",
        "ReportGeneratorDialog", "Open Report Generator",
    ),
    "Invoice Processor": _action(
        "cap.invoice_processor", "Invoice Processor",
        "Invoice creation, formatting, and calculation guidance.",
        "Invoice workspace with input, invoice generation, and output.",
        "Sending invoices and processing payments are not connected.",
        ["export"], "Medium",
        ["Business", "Enterprise", "All-Rounder"], ["Document Processor"],
        ["Always verify calculations.", "Do not send invoices automatically."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Create an invoice", "Format a service invoice"],
        "Invoice generation is local; payment processing is not connected.",
        "InvoiceProcessorDialog", "Open Invoice Processor",
    ),
    "Spreadsheet Analyst": _action(
        "cap.spreadsheet_analyst", "Spreadsheet Analyst",
        "Spreadsheet formulas, pivot tables, and data analysis guidance.",
        "Spreadsheet analysis workspace with input, guidance, and output.",
        "File access and external data connections require approval.",
        [], "Low",
        ALL_USE_CASES, ["Data Visualizer", "Statistical Modeler"],
        ["Test formulas on a copy first.", "Explain formula logic clearly."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Help with a VLOOKUP", "Create a pivot table"],
        "Spreadsheet guidance is local; file access is not connected.",
        "SpreadsheetAnalystDialog", "Open Spreadsheet Analyst",
    ),
    "Data Visualizer": _action(
        "cap.data_visualizer", "Data Visualizer",
        "Chart recommendations and data visualization guidance.",
        "Data visualization workspace with input, recommendations, and output.",
        "External data connections require approval.",
        [], "Low",
        ALL_USE_CASES, ["Spreadsheet Analyst", "Statistical Modeler"],
        ["Recommend appropriate chart types.", "Explain visualization rationale."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Recommend charts for my data", "Visualize sales trends"],
        "Visualization guidance is local; external data is not connected.",
        "DataVisualizerDialog", "Open Data Visualizer",
    ),
    "Statistical Modeler": _action(
        "cap.statistical_modeler", "Statistical Modeler",
        "Regression, hypothesis testing, and statistical analysis guidance.",
        "Statistical modeling workspace with input, analysis, and output.",
        "External data connections require approval.",
        [], "Medium",
        ["Educational", "Business", "Enterprise", "All-Rounder"], ["Data Visualizer", "Spreadsheet Analyst"],
        ["State assumptions clearly.", "Report effect sizes and confidence intervals."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Run a regression analysis", "Test for significant differences"],
        "Statistical analysis is local; external data is not connected.",
        "StatisticalModelerDialog", "Open Statistical Modeler",
    ),
    "Trend Forecaster": _action(
        "cap.trend_forecaster", "Trend Forecaster",
        "Forecasting and prediction from historical data patterns.",
        "Trend forecasting workspace with input, forecast, and output.",
        "External data connections require approval.",
        [], "Medium",
        ["Business", "Enterprise", "All-Rounder"], ["Data Visualizer", "Statistical Modeler"],
        ["Provide confidence intervals.", "Backtest forecasts when possible."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Forecast next quarter revenue", "Predict seasonal trends"],
        "Forecasting is local; external data is not connected.",
        "TrendForecasterDialog", "Open Trend Forecaster",
    ),
    "DevOps Assistant": _action(
        "cap.devops", "DevOps Assistant",
        "Deployment, CI/CD, and infrastructure guidance.",
        "DevOps workspace with input, guidance, and output.",
        "Infrastructure changes and deployments require approval.",
        ["shell", "file_write"], "High",
        ["Developer/Creator", "Enterprise", "All-Rounder"], ["Coder", "Script Writer"],
        ["Never deploy without approval.", "Test in staging first."],
        ["Capability Attachments", "Allowed Areas", "Approval Required"],
        ["Code Safety Library"],
        ["Set up a CI/CD pipeline", "Write a Dockerfile"],
        "DevOps guidance is local; infrastructure access is not connected.",
        "DevOpsAssistantDialog", "Open DevOps Assistant",
    ),
    "Database Manager": _action(
        "cap.database_manager", "Database Manager",
        "Database schema design, query optimization, and migration guidance.",
        "Database workspace with input, guidance, and output.",
        "Database access and migrations require approval.",
        ["shell"], "High",
        ["Developer/Creator", "Enterprise", "All-Rounder"], ["Coder", "DevOps Assistant"],
        ["Backup before migrations.", "Never run destructive queries without approval."],
        ["Capability Attachments", "Approval Required"],
        ["Code Safety Library"],
        ["Design a database schema", "Optimize a slow query"],
        "Database guidance is local; database access is not connected.",
        "DatabaseManagerDialog", "Open Database Manager",
    ),
    "Test Generator": _action(
        "cap.test_generator", "Test Generator",
        "Generate unit, integration, and edge case tests for code.",
        "Test generation workspace with input, test generation, and output.",
        "Test execution requires approval.",
        ["shell"], "Medium",
        ["Developer/Creator", "Enterprise", "All-Rounder"], ["Coder"],
        ["Cover edge cases and negative tests.", "Do not execute tests without approval."],
        ["Capability Attachments", "Common Prompts"],
        ["Code Safety Library"],
        ["Generate unit tests", "Write integration tests"],
        "Test generation is local; test execution is not connected.",
        "TestGeneratorDialog", "Open Test Generator",
    ),
    "Documentation Generator": _action(
        "cap.doc_generator", "Documentation Generator",
        "Generate API docs, READMEs, and user guides.",
        "Documentation workspace with input, generation, and output.",
        "File writes require approval.",
        ["file_write", "export"], "Low",
        ALL_USE_CASES, ["Coder", "Copy Editor"],
        ["Keep documentation clear and concise.", "Include examples."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Generate API docs", "Create a README"],
        "Documentation generation is local; file writes are approval-gated.",
        "DocumentationGeneratorDialog", "Open Documentation Generator",
    ),
    "Script Writer": _action(
        "cap.script_writer", "Script Writer",
        "Generate automation scripts in Python, shell, and PowerShell.",
        "Script writing workspace with input, generation, and output.",
        "Script execution requires approval.",
        ["shell", "file_write"], "High",
        ["Developer/Creator", "Enterprise", "All-Rounder"], ["Coder", "DevOps Assistant"],
        ["Test scripts in safe environment first.", "Never execute without approval."],
        ["Capability Attachments", "Approval Required"],
        ["Code Safety Library"],
        ["Write a batch rename script", "Create a backup script"],
        "Script generation is local; execution is not connected.",
        "ScriptWriterDialog", "Open Script Writer",
    ),
    "Copy Editor": _action(
        "cap.copy_editor", "Copy Editor",
        "Grammar, style, and clarity editing for text.",
        "Copy editing workspace with input, editing, and output.",
        "Publishing edited content requires approval.",
        ["export"], "Low",
        ALL_USE_CASES, ["Creative Writing", "Content Strategist"],
        ["Preserve author voice.", "Explain all changes."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Edit this text", "Check grammar and style"],
        "Copy editing is local; publishing is not connected.",
        "CopyEditorDialog", "Open Copy Editor",
    ),
    "Podcast Planner": _action(
        "cap.podcast_planner", "Podcast Planner",
        "Podcast episode planning, show notes, and segment structure.",
        "Podcast planning workspace with input, plan generation, and output.",
        "Publishing and scheduling require approval.",
        ["export"], "Low",
        ["Creative Studio", "Developer/Creator", "All-Rounder"], ["Content Strategist", "Creative Writing"],
        ["Plan engaging episode structures.", "Include show notes and timestamps."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Plan a podcast season", "Create show notes"],
        "Podcast planning is local; publishing is not connected.",
        "PodcastPlannerDialog", "Open Podcast Planner",
    ),
    "Brand Strategist": _action(
        "cap.brand_strategist", "Brand Strategist",
        "Brand identity, positioning, values, and personality development.",
        "Brand strategy workspace with input, strategy generation, and output.",
        "Brand asset deployment requires approval.",
        ["export"], "Low",
        ["Business", "Creative Studio", "All-Rounder"], ["Content Strategist", "Marketing Generator"],
        ["Align strategy with business goals.", "Be specific, not generic."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library", "Project Memory Library"],
        ["Develop a brand identity", "Create a positioning statement"],
        "Brand strategy is local; asset deployment is not connected.",
        "BrandStrategistDialog", "Open Brand Strategist",
    ),
    "Presentation Coach": _action(
        "cap.presentation_coach", "Presentation Coach",
        "Presentation structure, talking points, and delivery coaching.",
        "Presentation coaching workspace with input, coaching, and output.",
        "Slide generation and file export require approval.",
        ["export"], "Low",
        ALL_USE_CASES, ["Creative Writing", "Content Strategist"],
        ["Structure presentations clearly.", "Practice delivery timing."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Coach my presentation", "Create talking points"],
        "Presentation coaching is local; slide generation is not connected.",
        "PresentationCoachDialog", "Open Presentation Coach",
    ),
    "PR Assistant": _action(
        "cap.pr_assistant", "PR Assistant",
        "Press releases, media pitches, and crisis response statements.",
        "PR workspace with input, content generation, and output.",
        "Media distribution requires approval.",
        ["outbound messages", "export"], "Medium",
        ["Business", "Enterprise", "All-Rounder"], ["Content Strategist", "Copy Editor"],
        ["Keep press releases factual.", "Do not distribute without approval."],
        ["Capability Attachments", "Approval Required"],
        ["Communication Library"],
        ["Write a press release", "Craft a media pitch"],
        "PR content generation is local; media distribution is not connected.",
        "PRAssistantDialog", "Open PR Assistant",
    ),
    "Internal Comms Writer": _action(
        "cap.internal_comms", "Internal Comms Writer",
        "Company announcements, team updates, and change management messages.",
        "Internal comms workspace with input, generation, and output.",
        "Distribution to company channels requires approval.",
        ["outbound messages"], "Low",
        ["Business", "Enterprise", "All-Rounder"], ["Copy Editor", "Content Strategist"],
        ["Keep communications clear and empathetic.", "Do not send without approval."],
        ["Capability Attachments", "Common Prompts"],
        ["Communication Library"],
        ["Write a company announcement", "Draft a team update"],
        "Internal comms generation is local; distribution is not connected.",
        "InternalCommsWriterDialog", "Open Internal Comms Writer",
    ),
    "Academic Citation Manager": _action(
        "cap.citation_manager", "Academic Citation Manager",
        "Citation formatting in APA, MLA, Chicago, and other academic styles.",
        "Citation workspace with input, citation generation, and output.",
        "No outward actions.",
        [], "Low",
        ["Educational", "All-Rounder"], ["Research", "Document Processor"],
        ["Follow style guides exactly.", "Verify all citation details."],
        ["Capability Attachments", "Common Prompts"],
        ["Research Discipline Library"],
        ["Format citations in APA", "Create a bibliography"],
        "Citation formatting is local; no outward actions.",
        "AcademicCitationManagerDialog", "Open Citation Manager",
    ),
    "Patent Researcher": _action(
        "cap.patent_researcher", "Patent Researcher",
        "Prior art search, patent claim analysis, and research guidance.",
        "Patent research workspace with input, research guidance, and output.",
        "Patent filing requires legal professional.",
        [], "Medium",
        ["Business", "Enterprise", "Developer/Creator", "All-Rounder"], ["Research"],
        ["Informational only; consult a patent attorney.", "Search multiple databases."],
        ["Capability Attachments", "Common Prompts"],
        ["Research Discipline Library"],
        ["Search for prior art", "Analyze patent claims"],
        "Patent research is local; filing is not connected.",
        "PatentResearcherDialog", "Open Patent Researcher",
    ),
    "Market Analyst": _action(
        "cap.market_analyst", "Market Analyst",
        "Market size, trends, competitor analysis, and opportunity assessment.",
        "Market analysis workspace with input, analysis, and output.",
        "External data access requires approval.",
        [], "Medium",
        ["Business", "Enterprise", "All-Rounder"], ["Research", "Trend Forecaster"],
        ["Cite data sources.", "Distinguish facts from estimates."],
        ["Capability Attachments", "Common Prompts"],
        ["Research Discipline Library"],
        ["Analyze the SaaS market", "Identify competitors"],
        "Market analysis is local; external data is not connected.",
        "MarketAnalystDialog", "Open Market Analyst",
    ),
    "Recipe Planner": _action(
        "cap.recipe_planner", "Recipe Planner",
        "Meal planning, recipe suggestions, and weekly meal prep.",
        "Recipe planning workspace with input, recipe generation, and output.",
        "No outward actions.",
        [], "Low",
        ALL_USE_CASES, [],
        ["Balance nutrition and variety.", "Consider dietary restrictions."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Plan 5 dinners", "Suggest vegetarian meals"],
        "Recipe planning is local; no outward actions.",
        "RecipePlannerDialog", "Open Recipe Planner",
    ),
    "Travel Planner": _action(
        "cap.travel_planner", "Travel Planner",
        "Travel itinerary planning, activity suggestions, and logistics.",
        "Travel planning workspace with input, itinerary generation, and output.",
        "Booking and reservations require approval.",
        [], "Low",
        ALL_USE_CASES, [],
        ["Check visa requirements.", "Plan within budget."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Plan a 7-day trip", "Create a weekend itinerary"],
        "Travel planning is local; booking is not connected.",
        "TravelPlannerDialog", "Open Travel Planner",
    ),
    "Event Planner": _action(
        "cap.event_planner", "Event Planner",
        "Event planning with timeline, logistics, and checklists.",
        "Event planning workspace with input, plan generation, and output.",
        "Venue booking and invitations require approval.",
        ["outbound messages"], "Low",
        ["Business", "Enterprise", "All-Rounder"], ["Internal Comms Writer"],
        ["Create comprehensive checklists.", "Plan contingencies."],
        ["Capability Attachments", "Common Prompts"],
        ["Project Memory Library"],
        ["Plan a conference", "Organize a birthday party"],
        "Event planning is local; booking is not connected.",
        "EventPlannerDialog", "Open Event Planner",
    ),
    "Personal Finance Manager": _action(
        "cap.personal_finance", "Personal Finance Manager",
        "Budgeting, debt repayment, and savings goal guidance.",
        "Personal finance workspace with input, guidance, and output.",
        "Financial transactions are not connected.",
        [], "Medium",
        ALL_USE_CASES, [],
        ["General guidance only; not financial advice.", "Consult a certified financial advisor."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Create a monthly budget", "Plan debt repayment"],
        "Finance guidance is local; transactions are not connected.",
        "PersonalFinanceManagerDialog", "Open Finance Manager",
    ),
    "Privacy Compliance Checker": _action(
        "cap.privacy_compliance", "Privacy Compliance Checker",
        "GDPR, CCPA, and privacy regulation compliance guidance.",
        "Privacy compliance workspace with input, guidance, and output.",
        "Compliance certification requires legal professional.",
        [], "Medium",
        ["Business", "Enterprise", "All-Rounder"], ["Data Governance Advisor"],
        ["Informational only; consult a legal professional.", "Check all applicable regulations."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Check GDPR compliance", "Review privacy policy"],
        "Compliance guidance is local; certification is not connected.",
        "PrivacyComplianceCheckerDialog", "Open Privacy Checker",
    ),
    "Data Governance Advisor": _action(
        "cap.data_governance", "Data Governance Advisor",
        "Data governance framework, quality metrics, and stewardship roles.",
        "Data governance workspace with input, guidance, and output.",
        "Policy deployment requires organizational approval.",
        [], "Low",
        ["Business", "Enterprise", "All-Rounder"], ["Privacy Compliance Checker"],
        ["Align governance with business goals.", "Define clear stewardship roles."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Design a governance framework", "Create data quality metrics"],
        "Governance guidance is local; policy deployment is not connected.",
        "DataGovernanceAdvisorDialog", "Open Governance Advisor",
    ),
    "Curriculum Designer": _action(
        "cap.curriculum_designer", "Curriculum Designer",
        "Course and curriculum design with learning objectives and assessments.",
        "Curriculum design workspace with input, curriculum generation, and output.",
        "No outward actions.",
        ["export"], "Low",
        ["Educational", "All-Rounder"], ["Exam Prep Coach", "Tutor"],
        ["Align with learning objectives.", "Include assessments."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Design a Python course", "Create a training program"],
        "Curriculum design is local; no outward actions.",
        "CurriculumDesignerDialog", "Open Curriculum Designer",
    ),
    "Exam Prep Coach": _action(
        "cap.exam_prep_coach", "Exam Prep Coach",
        "Study plans, practice strategies, and exam preparation coaching.",
        "Exam prep workspace with input, study plan generation, and output.",
        "No outward actions.",
        [], "Low",
        ["Educational", "All-Rounder"], ["Curriculum Designer", "Tutor"],
        ["Assess baseline first.", "Include regular practice tests."],
        ["Capability Attachments", "Common Prompts"],
        [],
        ["Prepare for the SAT", "Create a study plan"],
        "Exam prep coaching is local; no outward actions.",
        "ExamPrepCoachDialog", "Open Exam Prep Coach",
    ),
}
...
def get_capability_action(capability_name: str) -> CapabilityAction | None:
    reg = CAPABILITY_REGISTRY.get(capability_name)
    if reg:
        return reg
...
def get_actions_for_ai(abilities: list[str]) -> list[tuple[str, str, str]]:
    """Return (ui_label, dialog_class_name, original_ability_name) deduped by registry key.

    Checks the original ability name in CAPABILITY_REGISTRY first (so dedicated dialogs
    are used when available), then falls back to canonical-intent lookup for aliases.
    """
    seen: set[str] = set()
    out: list[tuple[str, str, str]] = []
    for ab in abilities:
        reg = CAPABILITY_REGISTRY.get(ab)
        key = ab if reg else _canonical_ability(ab)
        if not reg:
            reg = CAPABILITY_REGISTRY.get(key)
        if not reg or key in seen:
            continue
        seen.add(key)
...
def get_available_actions_for_ai(
    ...
    for ab in abilities:
        action = CAPABILITY_REGISTRY.get(ab)
        key = ab if action else _canonical_ability(ab)
        if not action:
            action = CAPABILITY_REGISTRY.get(key)
...
def describe_capability_for_book(capability_name: str) -> list[str]:
    action = CAPABILITY_REGISTRY.get(capability_name)
    if not action:
        canonical = _canonical_ability(capability_name)
...
class BaseCapabilityDialog(QDialog):
    voice_command_ready = Signal(str)
    ...
    def _call_engine(self, system_prompt: str, user_prompt: str, temperature: float = 0.7) -> str:
        """Call the configured model backend with a capability-specific prompt.

        Returns the model's response text, or a safe fallback message if the
        backend is unavailable. This is the real engine that replaces simulated output.
        """
        try:
            ...
            response = backend.call_model(full_prompt, temperature=temperature)
            if response.error:
                return f"[Backend unavailable: {response.error}]\n\nFalling back to local mode. Please configure a model backend in Settings > Models for full capability."
            return response.text or "[No response from model backend.]"
        except Exception as e:
            return f"[Engine error: {e}]\n\nFalling back to local mode. Please configure a model backend in Settings > Models for full capability."

    def _build_capability_prompt(self, capability: str, task: str, extra_context: str = "") -> str:
        """Build a system prompt for a specific capability workflow."""
        guardrails_str = ", ".join(self._guardrails) if self._guardrails else "None"
        libraries_str = ", ".join(self._libraries) if self._libraries else "None"
        prompt = (
            f"You are {self._ai_name}, a Command Nexus AI assistant.\n"
            f"Capability: {capability}\n"
            f"Use case: {self._use_case}\n"
            f"Abilities: {', '.join(self._abilities) or 'general assistance'}\n"
            f"Guardrails: {guardrails_str}\n"
            f"Libraries: {libraries_str}\n"
        )
        if extra_context:
...
class CustomerSupportDialog(BaseCapabilityDialog):
    """Customer Support AI dialog wrapper — embeds CustomerAIWindow into a QDialog for chat companion routing."""

    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Customer Support AI — {ai_name} | Avery Logic Works(TM)")
        ...
        try:
            from ..customer_support.customer_ai_window import CustomerAIWindow
            self._customer_window = CustomerAIWindow(parent=self)
            layout.addWidget(self._customer_window, stretch=1)
        except Exception as e:
            err = QLabel(f"Customer Support AI module could not be loaded:\n{e}\n\nPlease ensure the customer_support module is installed.")
            err.setStyleSheet("color: #da3633; padding: 20px;")
            err.setWordWrap(True)
            layout.addWidget(err)

        footer = QLabel("Customer Support AI operates with proprietary safeguards. Internal architecture is never revealed. Avery Logic Works is not liable.")
...
def format_runtime_result(result, ai_name: str = "AI") -> str:
    ...
    message — surfaces the runtime's own specific status and guidance instead.
    """
...
class ChatCapabilityDialog(BaseCapabilityDialog):
    ...
    def focus_workflow(self, label: str):
        ...
        self.setWindowTitle(f"Workspace Chat — {self._ai_name} — {label}")
        self._append_ai(
...
class CodingCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_code_action(self, action):
        ...
        if not prompt:
            ...
            return
        if action == "explain":
            sys_prompt = self._build_capability_prompt("Coder", f"Explain the following code or concept in detail. Walk through key logic paths, flag potential risks or edge cases, and ask clarifying questions if needed.", extra_context=f"Code/Description: {prompt}")
            result = self._call_engine(sys_prompt, prompt, temperature=0.3)
            self._code_output.setText(result)
            self._set_result_summary("Code explanation generated via model backend. No file changes or commands were run.")
        elif action == "diff":
            sys_prompt = self._build_capability_prompt("Coder", f"Draft a code diff for the following request. Show the diff in a ```diff code block. Explain the changes.", extra_context=f"Request: {prompt}")
            result = self._call_engine(sys_prompt, prompt, temperature=0.2)
            self._code_output.setText(result)
            self._set_result_summary("Diff preview generated via model backend. Approved file editing remains approval-gated.")
        elif action == "test":
            sys_prompt = self._build_capability_prompt("Coder", f"Create a thorough test outline for the following. Include unit tests, integration tests, and edge cases.", extra_context=f"Request: {prompt}")
            result = self._call_engine(sys_prompt, prompt, temperature=0.3)
            self._code_output.setText(result)
            self._set_result_summary("Test plan generated via model backend. No commands were run.")
...
class ResearchCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_research(self, action):
        ...
        if not query:
            return
        if action == "research":
            sys_prompt = self._build_capability_prompt("Research", f"Research the following topic. Provide key findings with confidence labels (High/Medium/Low), separate facts from speculation, and list any sources you reference.", extra_context=f"Query: {query}")
            result = self._call_engine(sys_prompt, query, temperature=0.4)
            self._findings.setText(result)
            self._sources.setText("[SOURCES]\n\nSources cited in the research above. Live web search requires network approval and is not connected in this build.")
            self._set_result_summary(f"Research findings generated for '{query}'. Live web search remains approval-gated.")
        elif action == "compare":
            sys_prompt = self._build_capability_prompt("Research", f"Compare options for the following query. Create a structured comparison table with criteria, pros, cons, and a recommendation. Separate facts from assumptions.", extra_context=f"Comparison query: {query}")
            result = self._call_engine(sys_prompt, query, temperature=0.4)
            self._findings.setText(result)
            self._sources.setText("[SOURCES]\n\nSources cited in the comparison above. Live web search requires network approval.")
            self._set_result_summary(f"Comparison generated for '{query}'. Sources are model-derived until live research is connected.")
        elif action == "risks":
            sys_prompt = self._build_capability_prompt("Research", f"Identify risks and mitigations for the following. List each risk with severity, likelihood, and a concrete mitigation strategy.", extra_context=f"Risk analysis query: {query}")
            result = self._call_engine(sys_prompt, query, temperature=0.4)
            self._findings.setText(result)
            self._sources.setText("[SOURCES]\n\nSources cited in the risk analysis above. External source lookup remains approval-gated.")
            self._set_result_summary(f"Risk analysis generated for '{query}'. External source lookup remains approval-gated.")
...
class CreativeWriterCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_write_action(self, action):
        ...
        if action == "outline":
            sys_prompt = self._build_capability_prompt("Creative Writing", f"Create a detailed outline for the following writing task. Use {tone} tone for {audience or 'general'} audience. Include section headings, key points, and a logical flow.", extra_context=ctx)
            result = self._call_engine(sys_prompt, prompt, temperature=0.5)
            self._write_output.setText(result)
            self._set_result_summary("Writing outline generated via model backend. No file export or publishing occurred.")
        elif action == "draft":
            sys_prompt = self._build_capability_prompt("Creative Writing", f"Write a full draft for the following task. Use {tone} tone for {audience or 'general'} audience. Flag any invented content or assumptions.", extra_context=ctx)
            result = self._call_engine(sys_prompt, prompt, temperature=0.7)
            self._write_output.setText(result)
            self._set_result_summary("Draft generated via model backend. Save/export/publish remains approval-gated.")
        elif action == "revise":
            sys_prompt = self._build_capability_prompt("Creative Writing", f"Revise the following text for clarity, flow, and {tone} tone. Show the revised version with notes on what changed and why.", extra_context=ctx)
            result = self._call_engine(sys_prompt, prompt, temperature=0.6)
            self._write_output.setText(result)
            self._set_result_summary("Revision generated via model backend. No external distribution occurred.")
...
class PlannerCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_planner(self, action):
        ...
        if not goal:
            return
        if action == "plan":
            sys_prompt = self._build_capability_prompt("Planner", f"Create a detailed project plan for the following goal. Include scope, milestones, timeline, dependencies, stakeholders, and success criteria.", extra_context=f"Goal: {goal}")
            result = self._call_engine(sys_prompt, goal, temperature=0.4)
            self._plan_output.setText(result)
            self._set_result_summary("Plan generated via model backend. No task assignment or external commitment.")
        elif action == "risks":
            sys_prompt = self._build_capability_prompt("Planner", f"Identify risks and mitigations for the following goal. List each risk with severity, likelihood, impact, and a concrete mitigation strategy.", extra_context=f"Goal: {goal}")
            result = self._call_engine(sys_prompt, goal, temperature=0.4)
            self._plan_output.setText(result)
            self._set_result_summary("Risk analysis generated via model backend. No outward action was taken.")
        elif action == "tasks":
            sys_prompt = self._build_capability_prompt("Planner", f"Break down the following goal into a concrete task list. For each task, include a description, suggested owner role, estimated effort, and dependencies.", extra_context=f"Goal: {goal}")
            result = self._call_engine(sys_prompt, goal, temperature=0.4)
            self._plan_output.setText(result)
            self._set_result_summary("Task list generated via model backend. No tasks were assigned or exported.")
...
class NotebookCapabilityDialog(BaseCapabilityDialog):
    ...
    def _save_note(self):
        ...
        if not body:
            ...
            return
        notes_dir = Path.home() / "CommandNexusWorkspace" / "notes"
        notes_dir.mkdir(parents=True, exist_ok=True)
        safe_title = title or "untitled"
        safe_title = safe_title.replace(" ", "_").replace("/", "_")
        note_file = notes_dir / f"{safe_title}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
        try:
            note_file.write_text(f"Title: {title or 'Untitled'}\nTags: {tags or 'none'}\nDate: {datetime.now().isoformat()}\n\n{body}", encoding="utf-8")
            self._notes_output.append(f"Saved: [{title or 'Untitled'}] Tags: {tags or 'none'}\n  -> {note_file}\n---")
            self._set_result_summary(f"Note '{title or 'Untitled'}' saved to {note_file}.")
        except Exception as e:
            self._notes_output.append(f"Save failed: {e}\n---")
            self._set_result_summary(f"Note save failed: {e}")
    ...
    def _recall_notes(self):
        ...
        if not notes_dir.exists():
            self._notes_output.append("No saved notes found.")
            self._set_result_summary("No saved notes to recall.")
            return
        notes = sorted(notes_dir.glob("*.txt"), key=lambda p: p.stat().st_mtime, reverse=True)
        if tag_filter:
            notes = [n for n in notes if tag_filter.lower() in n.read_text(encoding="utf-8", errors="ignore").lower()]
        if not notes:
            self._notes_output.append(f"No notes found matching '{tag_filter}'.")
            self._set_result_summary(f"No notes matching filter '{tag_filter}'.")
            return
        for note_path in notes[:20]:
            try:
                content = note_path.read_text(encoding="utf-8", errors="ignore")
                lines = content.splitlines()
                header = lines[0] if lines else note_path.stem
                self._notes_output.append(f"[{header}]\n  {note_path}\n  {content[:200]}...\n---")
            except Exception:
                pass
        self._set_result_summary(f"Recalled {len(notes)} note(s) with filter '{tag_filter or 'all'}'.")
...
class DocumentProcessorCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_doc_action(self, action):
        ...
        if not text:
            ...
            return
        if action == "summarize":
            sys_prompt = self._build_capability_prompt("Document Processor", "Summarize the following document. Provide a concise overview, key points, and any notable concerns or sensitive content.")
            result = self._call_engine(sys_prompt, text, temperature=0.3)
            self._doc_output.setText(result)
            self._set_result_summary("Document summary generated via model backend. Export/save remains approval-gated.")
        elif action == "extract":
            sys_prompt = self._build_capability_prompt("Document Processor", "Extract action items from the following document. List each item with a clear description, suggested owner (if apparent), and priority.")
            result = self._call_engine(sys_prompt, text, temperature=0.3)
            self._doc_output.setText(result)
            self._set_result_summary("Action items extracted via model backend. No export occurred.")
        elif action == "compare":
            sys_prompt = self._build_capability_prompt("Document Processor", "Analyze the following document and provide a structured comparison of its key themes, positions, or data points. Highlight agreements, contradictions, and gaps.")
            result = self._call_engine(sys_prompt, text, temperature=0.3)
            self._doc_output.setText(result)
            self._set_result_summary("Document comparison generated via model backend. No source files were altered.")
...
class ArchiveCapabilityDialog(BaseCapabilityDialog):
    ...
    def _store_artifact(self):
        ...
        if not desc:
            ...
            return
        archive_dir = Path.home() / "CommandNexusWorkspace" / "archive"
        archive_dir.mkdir(parents=True, exist_ok=True)
        safe_name = (name or "untitled").replace(" ", "_").replace("/", "_")
        artifact_file = archive_dir / f"{safe_name}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
        try:
            artifact_file.write_text(f"Name: {name or 'Untitled'}\nTags: {tags or 'none'}\nDate: {datetime.now().isoformat()}\n\n{desc}", encoding="utf-8")
            self._archive_output.append(f"Stored: [{name or 'Untitled'}] Tags: {tags or 'none'}\n  -> {artifact_file}\n---")
            self._set_result_summary(f"Artifact '{name or 'Untitled'}' saved to {artifact_file}.")
        except Exception as e:
            self._archive_output.append(f"Archive failed: {e}\n---")
            self._set_result_summary(f"Archive save failed: {e}")
    ...
    def _retrieve_artifacts(self):
        ...
        if not archive_dir.exists():
            self._archive_output.append("No archived artifacts found.")
            self._set_result_summary("No archived artifacts to retrieve.")
            return
        artifacts = sorted(archive_dir.glob("*.txt"), key=lambda p: p.stat().st_mtime, reverse=True)
        if tag_filter:
            artifacts = [a for a in artifacts if tag_filter.lower() in a.read_text(encoding="utf-8", errors="ignore").lower()]
        if not artifacts:
            self._archive_output.append(f"No artifacts found matching '{tag_filter}'.")
            self._set_result_summary(f"No artifacts matching filter '{tag_filter}'.")
            return
        for art_path in artifacts[:20]:
            try:
                content = art_path.read_text(encoding="utf-8", errors="ignore")
                lines = content.splitlines()
                header = lines[0] if lines else art_path.stem
                self._archive_output.append(f"[{header}]\n  {art_path}\n  {content[:200]}...\n---")
            except Exception:
                pass
        self._set_result_summary(f"Retrieved {len(artifacts)} artifact(s) with filter '{tag_filter or 'all'}'.")
...
class ToolUserCapabilityDialog(BaseCapabilityDialog):
    ...
    def _propose_tool(self):
        ...
        if not tool:
            ...
            return
        sys_prompt = self._build_capability_prompt("Tool User", f"Evaluate the proposed tool use and provide a structured proposal. Include: tool name, purpose, expected outcome, risk assessment, prerequisites, and approval requirements. The tool is NOT being invoked — this is a proposal only.", extra_context=f"Tool: {tool}\nRationale: {rationale}")
        result = self._call_engine(sys_prompt, f"Tool: {tool}\nRationale: {rationale}", temperature=0.3)
        self._tool_output.setText(f"[PROPOSAL — AWAITING APPROVAL]\n\n{result}\n\nStatus: No tool was invoked. Approval required before execution.")
        self._set_result_summary(f"Tool proposal generated for '{tool}'. No tool was invoked.")

    def _list_tools(self):
        sys_prompt = self._build_capability_prompt("Tool User", "List and describe the tools that this AI assistant can propose using. For each tool, provide a name, description, risk level, and approval requirement. Note that no tools are being invoked.")
        result = self._call_engine(sys_prompt, "List available tools and their descriptions.", temperature=0.3)
        self._tool_output.setText(f"[AVAILABLE TOOLS]\n\n{result}\n\nNo tool was invoked.")
        self._set_result_summary("Available tool list generated via model backend. No tool was invoked.")
...
class TutorCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_tutor(self):
        ...
        if mode == "Explain":
            sys_prompt = self._build_capability_prompt("Tutor", f"Explain the following topic for a {level} learner. Provide a plain-language overview, key idea, concrete example, and a check-for-understanding question.", extra_context=f"Topic: {topic}, Level: {level}")
            result = self._call_engine(sys_prompt, topic, temperature=0.5)
        elif mode == "Quiz":
            sys_prompt = self._build_capability_prompt("Tutor", f"Create a quiz on the following topic for a {level} learner. Include short answer, multiple-choice, and explain-your-reasoning questions. Provide answers separately.", extra_context=f"Topic: {topic}, Level: {level}")
            result = self._call_engine(sys_prompt, topic, temperature=0.5)
        elif mode == "Lesson Plan":
            sys_prompt = self._build_capability_prompt("Tutor", f"Create a structured lesson plan for the following topic at {level} level. Include objective, warm-up, instruction, practice, and reflection sections.", extra_context=f"Topic: {topic}, Level: {level}")
            result = self._call_engine(sys_prompt, topic, temperature=0.5)
        elif mode == "Study Sheet":
            sys_prompt = self._build_capability_prompt("Tutor", f"Create a study sheet for the following topic at {level} level. Include key terms, core ideas, common mistakes, and practice prompts.", extra_context=f"Topic: {topic}, Level: {level}")
            result = self._call_engine(sys_prompt, topic, temperature=0.5)
        else:
            sys_prompt = self._build_capability_prompt("Tutor", f"Rewrite the following topic content for accessibility. Use simplified wording, clear steps, and short sections suitable for a {level} learner.", extra_context=f"Topic: {topic}, Level: {level}")
            result = self._call_engine(sys_prompt, topic, temperature=0.5)
        self._tutor_output.setText(result)
        self._set_result_summary(f"{mode} tutor output generated via model backend for '{topic[:80]}'. Export remains approval-gated.")
...
class BusinessWorkflowCapabilityDialog(BaseCapabilityDialog):
    ...
    def _run_business_workflow(self):
        ...
        if mode == "SOP":
            sys_prompt = self._build_capability_prompt("Business Workflow", f"Create a detailed Standard Operating Procedure (SOP) for the following context. Include purpose, scope, inputs, step-by-step procedure, approval points, and escalation path.", extra_context=f"Context: {context}")
            result = self._call_engine(sys_prompt, context, temperature=0.4)
        elif mode == "Checklist":
            sys_prompt = self._build_capability_prompt("Business Workflow", f"Create a thorough checklist for the following context. Include all necessary verification steps, risk checks, and approval gates.", extra_context=f"Context: {context}")
            result = self._call_engine(sys_prompt, context, temperature=0.4)
        elif mode == "Support Draft":
            sys_prompt = self._build_capability_prompt("Business Workflow", f"Draft a professional support response for the following context. The draft should be empathetic, clear, and actionable. Mark it as 'DRAFT — not sent'.", extra_context=f"Context: {context}")
            result = self._call_engine(sys_prompt, context, temperature=0.5)
        elif mode == "Handoff Packet":
            sys_prompt = self._build_capability_prompt("Business Workflow", f"Create a handoff packet for the following context. Include summary, owner, open questions, risks, and next steps.", extra_context=f"Context: {context}")
            result = self._call_engine(sys_prompt, context, temperature=0.4)
        else:
            sys_prompt = self._build_capability_prompt("Business Workflow", f"Create an automation plan for the following context. Include trigger, inputs, steps, approval checkpoints, rollback plan, and audit record requirements.", extra_context=f"Context: {context}")
            result = self._call_engine(sys_prompt, context, temperature=0.4)
        self._business_output.setText(result)
        self._set_result_summary(f"{mode} generated via model backend. No message, export, or automation was executed.")
...
class HephaestusRelayCapabilityDialog(BaseCapabilityDialog):
    ...
    def _build_handoff(self):
        ...
        if not goal:
            ...
            return
        sys_prompt = self._build_capability_prompt("Hephaestus Relay", f"Create a Hephaestus-ready handoff brief for the following design idea. Structure it with: Purpose, Constraints/Materials/Scale/Unknowns, Desired outcome, Non-negotiable constraints, Unknowns requiring investigation, Safety/feasibility concerns, and Suggested next specialist review.", extra_context=f"Purpose: {goal}\nConstraints: {constraints or 'Not specified'}")
        result = self._call_engine(sys_prompt, goal, temperature=0.4)
        self._handoff_output.setText(result)
        self._set_result_summary("Hephaestus-ready handoff brief generated via model backend. No Hephaestus internals were touched.")
...
class GameCompanionDialog(BaseCapabilityDialog):
    ...
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        ...
        tabs.addTab(self._build_coop_tab(), "Co-Op Partner")
        tabs.addTab(self._build_playstyle_tab(), "Playstyle & Learning")
        layout.addWidget(tabs, stretch=1)
    ...
    def _build_coop_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("P2 Co-Op Partner Mode"))
        l.addWidget(QLabel("Configure your AI partner for co-op or competitive play:"))
        l.addWidget(QLabel("Partner Playstyle:"))
        self._coop_playstyle = QComboBox()
        self._coop_playstyle.addItems([
            "Defensive — holds ground, protects objectives, plays safe",
            "Decoy — draws attention, misleads opponents, creates openings",
            "Cooperative Team — coordinates with you, shares info, supports your plan",
            "Solo Aggressor — independent attacker, applies pressure, takes risks",
            "Secret Finder — explores map, finds hidden items/intel, scouts ahead",
            "Support — heals, buffs, resupplies, covers your back",
            "Balanced — adapts to the situation dynamically",
            "Trickster — unpredictable, bluffs, fakes, keeps opponents guessing",
            "Economist — focuses on resource advantage, long-term scaling",
            "Speedrunner — optimizes for fast execution, skips non-essentials",
        ])
        l.addWidget(self._coop_playstyle)
        l.addWidget(QLabel("Game Type:"))
        self._coop_game_type = QComboBox()
        self._coop_game_type.addItems([
            "PC Game (FPS/TPS)", "PC Game (RTS/MOBA)", "PC Game (RPG/Co-op)",
            "Board Game", "Card Game", "Chess/Abstract Strategy",
            "Sports Game", "Fighting Game", "Party/Social Game",
        ])
        l.addWidget(self._coop_game_type)
        l.addWidget(QLabel("Partner Skill Level:"))
        self._coop_skill = QComboBox()
        self._coop_skill.addItems(["Novice", "Casual", "Skilled", "Expert", "Adaptive (learns)"])
        l.addWidget(self._coop_skill)
        l.addWidget(QLabel("Communication Mode:"))
        self._coop_comm = QComboBox()
        self._coop_comm.addItems([
            "Verbose — explains every decision in detail",
            "Concise — short callouts only",
            "Silent — plays without commentary, results only",
            "Strategic — high-level plan updates and strategic calls",
        ])
        l.addWidget(self._coop_comm)
        l.addWidget(QLabel("Describe your current game situation:"))
        self._coop_situation = QTextEdit()
        self._coop_situation.setPlaceholderText(
            "e.g., 'We're playing a 2v2 FPS match on a map with two chokepoints. "
            "I'm playing sniper. The enemy is holding the central building.'"
        )
        self._coop_situation.setMaximumHeight(80)
        l.addWidget(self._coop_situation)
        btn_row = QHBoxLayout()
        gen_btn = QPushButton("Get Partner Strategy")
        gen_btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        gen_btn.clicked.connect(self._run_coop_strategy)
        btn_row.addWidget(gen_btn)
        adapt_btn = QPushButton("Adapt Mid-Game")
        adapt_btn.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        adapt_btn.clicked.connect(self._run_coop_adapt)
        btn_row.addWidget(adapt_btn)
        l.addLayout(btn_row)
        self._coop_output = QTextEdit()
        self._coop_output.setReadOnly(True)
        l.addWidget(self._coop_output, stretch=1)
        return w

    def _run_coop_strategy(self):
        playstyle = self._coop_playstyle.currentText()
        game_type = self._coop_game_type.currentText()
        skill = self._coop_skill.currentText()
        comm = self._coop_comm.currentText()
        situation = self._coop_situation.toPlainText().strip()
        task = (
            f"Act as a P2 co-op partner for a {game_type} game. Playstyle: {playstyle}. "
            f"Skill level: {skill}. Communication: {comm}. "
            f"Situation: {situation or 'General gameplay'}. "
            f"Provide a detailed strategy: what the partner should do, how to coordinate with P1, "
            f"key objectives, positioning, and communication plan."
        )
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._coop_output.setText(ai_result)
            self._set_result_summary(f"Co-op strategy via AI: {playstyle.split(' — ')[0]}")
            return
        ps_key = playstyle.split(" — ")[0].lower().replace(" ", "_")
        ps_profiles = {
            "defensive": {
                "priorities": ["Hold key positions and chokepoints", "Protect objectives and assets", "Minimize unnecessary risks", "Create safe zones for P1"],
                "positioning": "Stay between the threat and the objective. Use cover and sightlines to control approach routes. Fall back gracefully rather than overextending.",
                "coordination": "Call out enemy movements. Cover P1's flanks while they execute. Trade space for time when overwhelmed.",
                "weaknesses": "Can be too passive — opponent may gain map control. Needs to recognize when to counter-attack.",
                "best_with": "Aggressive P1 players who need a safe anchor, objective-focused game modes",
            },
            "decoy": {
                "priorities": ["Draw enemy attention away from P1's plan", "Create confusion and misdirection", "Bait opponents into bad positions", "Feint attacks to reveal enemy positions"],
                "positioning": "Visible but mobile — stay where enemies can see you, but always have an escape route. Move unpredictably between cover.",
                "coordination": "Signal P1 when you're drawing aggro. Time your feints with P1's real push. Never commit fully to the decoy — always have an exit.",
                "weaknesses": "Can get caught if escape fails. Must not sacrifice too much. Needs P1 to capitalize on the distraction.",
                "best_with": "Stealthy or sniper P1 players, flanking strategies, objective raids",
            },
            "cooperative_team": {
                "priorities": ["Share information constantly", "Support P1's plan directly", "Cover weaknesses in P1's approach", "Coordinate timing on pushes and retreats"],
                "positioning": "Stay within supporting distance of P1 — close enough to help, far enough to avoid both being caught in the same AoE/ambush.",
                "coordination": "Use clear callouts. Agree on signals before executing. Synchronize ultimates/abilities. Never split without communication.",
                "weaknesses": "Can become predictable if always following P1. Needs to suggest alternative plans when the current one isn't working.",
                "best_with": "All game types, especially team-based modes requiring coordination",
            },
            "solo_aggressor": {
                "priorities": ["Apply constant pressure on the enemy", "Take calculated risks for high reward", "Force opponents to react to you", "Create chaos in the enemy's backline"],
                "positioning": "Aggressive forward positions. Flank routes. Enemy territory. Always moving — never stay in one spot too long.",
                "coordination": "Tell P1 where you're hitting so they can exploit the gaps you create. Time your aggression with P1's objective play.",
                "weaknesses": "Can get isolated and killed. May feed the opponent if risks don't pay off. Needs to know when to fall back.",
                "best_with": "Defensive or objective-focused P1 players, distraction strategies, aggressive game modes",
            },
            "secret_finder": {
                "priorities": ["Explore the map thoroughly", "Find hidden items, secrets, and intel", "Scout enemy positions and movements", "Identify alternative routes and strategies"],
                "positioning": "Off the beaten path. Check corners, side routes, and hidden areas. Stay mobile and avoid direct engagements.",
                "coordination": "Report what you find to P1. Mark interesting locations. Identify enemy positions for P1 to exploit.",
                "weaknesses": "Not contributing to direct combat. May miss time-sensitive objectives while exploring.",
                "best_with": "RPGs, exploration games, games with hidden content, scouting phases",
            },
            "support": {
                "priorities": ["Keep P1 alive and effective", "Provide healing, buffs, ammo, or utility", "Watch P1's back", "Enable P1 to play at their best"],
                "positioning": "Behind or beside P1 — close enough to assist, protected from direct fire. Position to cover P1's blind spots.",
                "coordination": "Communicate cooldowns and resource availability. Warn P1 of incoming threats. Time your support abilities with P1's aggressive moves.",
                "weaknesses": "Low direct combat power. Can be targeted first by smart opponents. Needs P1 to protect them in return.",
                "best_with": "RPGs with healers, shooters with support roles, any game with role specialization",
            },
            "balanced": {
                "priorities": ["Adapt to the situation dynamically", "Fill whatever role is needed", "Switch between aggressive and defensive as required", "Respond to P1's needs in real-time"],
                "positioning": "Flexible — move between forward and back positions based on game state. Read the flow and adjust.",
                "coordination": "Communicate role switches. Ask P1 what they need. Be ready to pivot when the situation changes.",
                "weaknesses": "Can be indecisive without clear direction. Needs strong game sense to adapt effectively.",
                "best_with": "All game types, especially dynamic games with shifting objectives",
            },
            "trickster": {
                "priorities": ["Keep opponents guessing", "Mix real and fake moves", "Exploit psychology and prediction", "Create uncertainty in the enemy's decisions"],
                "positioning": "Unpredictable positions. Show yourself where you aren't expected. Disappear and reappear in different areas.",
                "coordination": "Tell P1 which moves are real and which are bluffs. Coordinate so P1 can punish opponents who fall for the trick.",
                "weaknesses": "Can confuse P1 if communication is poor. High-risk playstyle that can backfire against experienced opponents.",
                "best_with": "Mind-game-heavy games, fighting games, card games, psychological warfare",
            },
            "economist": {
                "priorities": ["Build resource advantage over time", "Optimize income, upgrades, and scaling", "Make efficient trades", "Win the long game through superior economy"],
                "positioning": "Safe, resource-rich areas. Prioritize income generation and upgrade paths. Avoid risky early confrontations.",
                "coordination": "Inform P1 of resource timing. Coordinate when to invest and when to spend. Plan power spikes together.",
                "weaknesses": "Vulnerable to early aggression. Can fall behind if opponent snowballs. Needs time to scale.",
                "best_with": "RTS games, MOBAs, board games with resource management, any game with economic depth",
            },
            "speedrunner": {
                "priorities": ["Optimize for fastest completion", "Skip non-essential content", "Execute precise, efficient movement", "Find the shortest path to victory"],
                "positioning": "Direct routes to objectives. Skip side areas. Minimize backtracking. Movement-optimized paths.",
                "coordination": "Communicate the optimal route. Tell P1 what to skip. Synchronize timing for fast execution.",
                "weaknesses": "Can miss important resources or upgrades. Less flexible if the plan goes wrong. High execution difficulty.",
                "best_with": "Platformers, puzzle games, any game with time-based scoring or speedrun potential",
            },
        }
        profile = ps_profiles.get(ps_key, ps_profiles["balanced"])
        output = f"[P2 CO-OP PARTNER STRATEGY — LOCAL]\n\n"
        output += f"Playstyle: {playstyle}\nGame Type: {game_type}\nSkill: {skill}\nComm: {comm}\n"
        if situation:
            output += f"Situation: {situation[:200]}\n"
        output += "\nPARTNER PRIORITIES:\n"
        ...
        output += f"\nBEST PAIRED WITH:\n  {profile['best_with']}\n"
        gt_tips = {
            "PC Game (FPS/TPS)": ["Use ping system for enemy locations", "Trade kills favorably", "Watch minimap for rotations", "Save utility for key moments"],
            "PC Game (RTS/MOBA)": ["Coordinate ability combos", "Time power spikes with objectives", "Ward for vision", "Communicate cooldowns"],
            "Board Game": ["Discuss strategy before each turn", "Plan multiple moves ahead", "Track opponent resources", "Agree on aggression timing"],
            "Card Game": ["Share hand info subtly", "Coordinate card timing", "Track opponent's played cards", "Plan combo sequences"],
        }
        tips = gt_tips.get(game_type, gt_tips.get("PC Game (FPS/TPS)", []))
        output += "\nGAME-SPECIFIC TIPS:\n"
        for t in tips:
            output += f"  • {t}\n"
        comm_profiles = {
            "Verbose": "Explain reasoning before each major action. Provide analysis of options. Full situational updates.",
            "Concise": "Short callouts: 'Enemy at A', 'Need help B', 'Pushing C'. No unnecessary chatter.",
            "Silent": "No commentary during play. Provide summary analysis after each round. Focus on execution.",
            "Strategic": "High-level updates: 'Plan A working', 'Switching to Plan B', 'Power spike in 30s — prepare push'.",
        }
        output += f"\nCOMMUNICATION PLAN:\n  {comm_profiles.get(comm, comm_profiles['Concise'])}\n"
        skill_behaviors = {
            "Novice": "Simple, safe plays. Follow P1's lead. Ask for guidance. Focus on learning mechanics.",
            "Casual": "Competent basic play. Reasonable independent decisions. Occasionally suggests strategies.",
            "Skilled": "Strong independent play. Anticipates enemy moves. Proactively suggests counter-strategies.",
            "Expert": "Optimal play. Reads enemy patterns. Calls advanced strategies. Carries when P1 struggles.",
            "Adaptive (learns)": "Starts moderate. Adjusts difficulty based on P1's performance. Improves over repeated sessions by learning patterns.",
        }
        output += f"\nSKILL BEHAVIOR:\n  {skill_behaviors.get(skill, skill_behaviors['Casual'])}\n"
        output += "\nThe built-in intelligence can provide a fully personalized co-op strategy."
        self._coop_output.setText(output)
        self._set_result_summary(f"Co-op strategy: {playstyle.split(' — ')[0]}")

    def _run_coop_adapt(self):
        playstyle = self._coop_playstyle.currentText()
        game_type = self._coop_game_type.currentText()
        situation = self._coop_situation.toPlainText().strip()
        if not situation:
            self._coop_output.setText("Describe your current mid-game situation for adaptation advice.")
            return
        task = (
            f"Mid-game adaptation for P2 co-op partner. Game: {game_type}. Playstyle: {playstyle}. "
            f"New situation: {situation}. How should the partner adapt?"
        )
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._coop_output.setText(ai_result)
            self._set_result_summary("Co-op adaptation via AI")
            return
        ps_name = playstyle.split(" — ")[0]
        output = f"[MID-GAME ADAPTATION — LOCAL]\n\nOriginal: {ps_name} | Game: {game_type}\nSituation: {situation[:200]}\n\n"
        output += "ADAPTATION FRAMEWORK:\n  1. ASSESS — What changed?\n  2. DECIDE — Switch playstyle or adjust?\n  3. COMMUNICATE — Tell P1 what's changing\n  4. EXECUTE — Implement immediately\n  5. EVALUATE — Check after 2-3 engagements\n\n"
        switch_map = {
            "Defensive": ["Solo Aggressor (counter-attack)", "Balanced (flexible)"],
            "Decoy": ["Cooperative Team (direct support)", "Solo Aggressor (real pressure)"],
            "Cooperative Team": ["Solo Aggressor (split pressure)", "Decoy (misdirection)"],
            "Solo Aggressor": ["Defensive (reset)", "Support (enable P1)"],
            "Secret Finder": ["Cooperative Team (join fights)", "Support (assist P1)"],
            "Support": ["Defensive (hold ground)", "Cooperative Team (active)"],
            "Balanced": ["Any specific playstyle based on needs"],
            "Trickster": ["Solo Aggressor (real aggression)", "Cooperative Team (honest)"],
            "Economist": ["Defensive (protect resources)", "Solo Aggressor (spend advantage)"],
            "Speedrunner": ["Balanced (adapt to obstacles)", "Cooperative Team (safe)"],
        }
        output += "PLAYSTYLE SWITCH OPTIONS:\n"
        for alt in switch_map.get(ps_name, ["Balanced (adapt)"]):
            output += f"  → {alt}\n"
        output += "\nADAPTATION TRIGGERS:\n  • Enemy countering? → Switch playstyle\n  • P1 struggling? → Support/Cooperative\n  • Enemy mistakes? → Aggressor/Trickster\n  • Low time/resources? → Speedrunner/Economist\n"
        output += "\nThe built-in intelligence can analyze your specific situation."
        self._coop_output.setText(output)
        self._set_result_summary("Co-op mid-game adaptation")

    # ── Playstyle & Learning Tab ──

    def _build_playstyle_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Playstyle & Adaptive Learning"))
        l.addWidget(QLabel("Track patterns, learn from sessions, and refine your AI partner's play over time."))
        l.addWidget(QLabel("Log a Learning Session:"))
        row1 = QHBoxLayout()
        row1.addWidget(QLabel("Game:"))
        self._learn_game = QLineEdit()
        self._learn_game.setPlaceholderText("e.g., Chess, Valorant, Catan...")
        row1.addWidget(self._learn_game)
        row1.addWidget(QLabel("Outcome:"))
        self._learn_outcome = QComboBox()
        self._learn_outcome.addItems(["Win", "Loss", "Draw", "Partial success", "Learning session"])
        row1.addWidget(self._learn_outcome)
        l.addLayout(row1)
        l.addWidget(QLabel("What worked well:"))
        self._learn_worked = QTextEdit()
        self._learn_worked.setPlaceholderText("Strategies, tactics, or decisions that were effective...")
        self._learn_worked.setMaximumHeight(60)
        l.addWidget(self._learn_worked)
        l.addWidget(QLabel("What didn't work:"))
        self._learn_failed = QTextEdit()
        self._learn_failed.setPlaceholderText("Mistakes, failed strategies, or missed opportunities...")
        self._learn_failed.setMaximumHeight(60)
        l.addWidget(self._learn_failed)
        l.addWidget(QLabel("Opponent patterns noticed:"))
        self._learn_patterns = QTextEdit()
        self._learn_patterns.setPlaceholderText("Recurring opponent behaviors, tendencies, or exploitable habits...")
        self._learn_patterns.setMaximumHeight(60)
        l.addWidget(self._learn_patterns)
        log_btn = QPushButton("Log Learning Session")
        log_btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        log_btn.clicked.connect(self._run_learn_log)
        l.addWidget(log_btn)
        row2 = QHBoxLayout()
        analyze_btn = QPushButton("Analyze Learning")
        analyze_btn.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        analyze_btn.clicked.connect(self._run_learn_analyze)
        row2.addWidget(analyze_btn)
        recommend_btn = QPushButton("Get Playstyle Recommendation")
        recommend_btn.setStyleSheet("background-color: #8957e5; color: white; font-weight: bold; padding: 8px;")
        recommend_btn.clicked.connect(self._run_learn_recommend)
        row2.addWidget(recommend_btn)
        l.addLayout(row2)
        self._learn_output = QTextEdit()
        self._learn_output.setReadOnly(True)
        l.addWidget(self._learn_output, stretch=1)
        self._learning_log: list[dict] = []
        return w

    def _run_learn_log(self):
        game = self._learn_game.text().strip()
        if not game:
            self._learn_output.setText("Enter a game name.")
            return
        outcome = self._learn_outcome.currentText()
        worked = self._learn_worked.toPlainText().strip()
        failed = self._learn_failed.toPlainText().strip()
        patterns = self._learn_patterns.toPlainText().strip()
        entry = {"game": game, "outcome": outcome, "worked": worked, "failed": failed, "patterns": patterns}
        self._learning_log.append(entry)
        self._learn_game.clear()
        self._learn_worked.clear()
        self._learn_failed.clear()
        self._learn_patterns.clear()
        self._learn_output.setText(
            f"Learning session logged: {game} — {outcome}\n"
            f"Total learning sessions: {len(self._learning_log)}\n\n"
            "Use 'Analyze Learning' to identify patterns across sessions.\n"
            "Use 'Get Playstyle Recommendation' for AI-suggested playstyle based on your history."
        )
        self._set_result_summary(f"Learning logged: {game} — {outcome}")

    def _run_learn_analyze(self):
        if not self._learning_log:
            self._learn_output.setText("No learning sessions logged yet. Log some sessions first!")
            return
        task = (
            f"Analyze {len(self._learning_log)} game learning sessions and identify patterns. "
            f"Sessions: {self._learning_log}. What strategies consistently work? What fails? "
            f"What opponent patterns are exploitable? How should the AI partner adapt?"
        )
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._learn_output.setText(ai_result)
            self._set_result_summary("Learning analysis via AI")
            return
        total = len(self._learning_log)
        wins = sum(1 for e in self._learning_log if e["outcome"] == "Win")
        losses = sum(1 for e in self._learning_log if e["outcome"] == "Loss")
        games: dict[str, int] = {}
        worked_list: list[str] = []
        failed_list: list[str] = []
        pattern_list: list[str] = []
        for e in self._learning_log:
            games[e["game"]] = games.get(e["game"], 0) + 1
            if e["worked"]:
                worked_list.append(f"[{e['game']}] {e['worked']}")
            if e["failed"]:
                failed_list.append(f"[{e['game']}] {e['failed']}")
            if e["patterns"]:
                pattern_list.append(f"[{e['game']}] {e['patterns']}")
        output = f"[LEARNING ANALYSIS — LOCAL]\n\nTotal sessions: {total}\n  Wins: {wins}  Losses: {losses}\n\n"
        output += "GAMES PLAYED:\n"
        for g, c in sorted(games.items(), key=lambda x: -x[1]):
            output += f"  {g}: {c} session(s)\n"
        output += "\nWHAT WORKED:\n"
        for entry in worked_list[-10:]:
            output += f"  • {entry[:100]}\n"
        output += "\nWHAT FAILED:\n"
        for entry in failed_list[-10:]:
            output += f"  • {entry[:100]}\n"
        output += "\nOPPONENT PATTERNS:\n"
        for entry in pattern_list[-10:]:
            output += f"  • {entry[:100]}\n"
        output += "\nADAPTATION INSIGHTS:\n  • Do more of what worked\n  • Avoid or modify what failed\n  • Develop counter-strategies for opponent patterns\n  • Track playstyle-win correlations\n  • Practice weak areas\n"
        output += "\nThe built-in intelligence can provide deep pattern analysis and personalized recommendations."
        self._learn_output.setText(output)
        self._set_result_summary(f"Learning analysis: {total} sessions")

    def _run_learn_recommend(self):
        if not self._learning_log:
            self._learn_output.setText("No learning sessions logged yet. Log sessions to get playstyle recommendations!")
            return
        task = (
            f"Based on {len(self._learning_log)} learning sessions: {self._learning_log}. "
            f"Recommend the best playstyle. Consider wins, losses, what worked, what failed, and opponent patterns. "
            f"Choose from: Defensive, Decoy, Cooperative Team, Solo Aggressor, Secret Finder, "
            f"Support, Balanced, Trickster, Economist, Speedrunner."
        )
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._learn_output.setText(ai_result)
            self._set_result_summary("Playstyle recommendation via AI")
            return
        wins = sum(1 for e in self._learning_log if e["outcome"] == "Win")
        losses = sum(1 for e in self._learning_log if e["outcome"] == "Loss")
        total = len(self._learning_log)
        win_rate = wins / total * 100 if total else 0
        all_worked = " ".join(e["worked"] for e in self._learning_log if e["worked"]).lower()
        all_failed = " ".join(e["failed"] for e in self._learning_log if e["failed"]).lower()
        all_patterns = " ".join(e["patterns"] for e in self._learning_log if e["patterns"]).lower()
        recommendations: list[tuple[str, str]] = []
        keyword_map = [
            (["aggressive", "pressure", "flank"], "Solo Aggressor", "Aggression and pressure led to wins."),
            (["defend", "hold", "safe"], "Defensive", "Holding positions and safe play worked."),
            (["coordinate", "team", "support"], "Cooperative Team", "Coordination and teamwork won games."),
            (["scout", "explore", "find"], "Secret Finder", "Exploration and scouting led to success."),
            (["heal", "buff", "protect"], "Support", "Supporting your partner was key."),
            (["bluff", "fake", "trick"], "Trickster", "Deception and unpredictability worked."),
            (["resource", "economy", "scale"], "Economist", "Economic advantage was your path to victory."),
            (["fast", "speed", "quick"], "Speedrunner", "Speed and efficiency won games."),
            (["decoy", "distract", "bait"], "Decoy", "Drawing attention and misdirection worked."),
        ]
        for keywords, style, reason in keyword_map:
            if any(k in all_worked for k in keywords):
                recommendations.append((style, reason))
        if not recommendations:
            if win_rate > 60:
                recommendations.append(("Balanced", "Strong win rate — stay flexible and adaptive."))
            elif win_rate > 40:
                recommendations.append(("Balanced", "Mixed results — adapt to each situation."))
            else:
                recommendations.append(("Cooperative Team", "Lower win rate — coordination with P1 may help."))
        output = f"[PLAYSTYLE RECOMMENDATION — LOCAL]\n\nBased on {total} sessions ({wins}W/{losses}L, {win_rate:.0f}% win rate)\n\n"
        output += "RECOMMENDED PLAYSTYLES:\n"
        for i, (style, reason) in enumerate(recommendations, 1):
            output += f"  {i}. {style}\n     Reason: {reason}\n"
        output += "\nANTI-RECOMMENDATIONS:\n"
        anti_added = False
        if "aggressive" in all_failed:
            output += "  • Avoid Solo Aggressor — aggression led to losses\n"
            anti_added = True
        if "defend" in all_failed or "passive" in all_failed:
            output += "  • Avoid Defensive — being too passive cost games\n"
            anti_added = True
        if "trick" in all_failed or "bluff" in all_failed:
            output += "  • Avoid Trickster — deception backfired\n"
            anti_added = True
        if not anti_added:
            output += "  • No strong anti-patterns detected yet — keep logging sessions\n"
        if all_patterns:
            output += f"\nOPPONENT EXPLOITATION:\n  Patterns detected: {all_patterns[:200]}\n  Develop counter-strategies for these.\n"
        output += "\nThe built-in intelligence can provide personalized recommendations based on your full game history."
        self._learn_output.setText(output)
        self._set_result_summary("Playstyle recommendation")
...
class DataAnalystDialog(BaseCapabilityDialog):
    ...
    def _run_summary(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Data Analyst Pro",
            f"Provide a brief data insight summary for this dataset: {n} points, mean={mean:.2f}, median={median:.2f}, "
            f"min={minimum:.2f}, max={maximum:.2f}, range={rng:.2f}. Highlight notable patterns, potential anomalies, "
            f"and suggest further analysis."
        )
        ai_insight = self._call_engine(sys_prompt, f"Data: {data[:50]}", temperature=0.3)
...
class CodeReviewerDialog(BaseCapabilityDialog):
    ...
    def _run_quality(self):
        ...
        if code:
            lang = self._review_lang.currentText()
            task = f"Assess the code quality of this {lang} code. Check readability, structure, error handling, testing coverage, documentation, and maintainability. Provide specific recommendations.\n\n{code}"
            ai_result = self._run_through_runtime(task)
            if ai_result:
                self._quality_output.setText(ai_result)
                self._set_result_summary("Quality check via AI.")
                return
        output = (
...
class SecurityAuditorDialog(BaseCapabilityDialog):
    ...
    def _run_access(self):
        target = self._vuln_target.text().strip() or "system"
        scope = self._vuln_scope.toPlainText().strip()
        task = f"Perform a defensive access control review for: {target}. Scope: {scope}. Include authentication, authorization, session management, API security, and administrative access checklist."
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._access_output.setText(ai_result)
            self._set_result_summary(f"Access control review via AI: {target}.")
            return
        output = (
    ...
    def _run_data(self):
        target = self._vuln_target.text().strip() or "system"
        scope = self._vuln_scope.toPlainText().strip()
        task = f"Perform a data protection assessment for: {target}. Scope: {scope}. Include data classification, encryption, access controls, privacy, backup & recovery, and data disposal."
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._data_output.setText(ai_result)
            self._set_result_summary(f"Data protection assessment via AI: {target}.")
            return
        output = (
    ...
    def _run_compliance(self):
        ...
        target = self._vuln_target.text().strip() or "system"
        task = f"Generate a compliance assessment for {target} using the {framework} framework. Include key controls, assessment status, and remediation recommendations."
        ai_result = self._run_through_runtime(task)
        if ai_result:
            self._compliance_output.setText(ai_result)
            self._set_result_summary(f"Compliance grid via AI: {framework}.")
            return
        frameworks = {
            "OWASP Top 10": [
...
class HabitTrackerDialog(BaseCapabilityDialog):
    ...
    def _calc_strength(self):
        if not self._habits:
            ...
            return
        habit_summary = "\n".join(
            f"- {h['name']}: {h['streak']} day streak (best: {h['best_streak']}), "
            f"{len(h['checkins'])} check-ins, target: {h['target']} days"
            for h in self._habits
        )
        sys_prompt = self._build_capability_prompt(
            "Habit Tracker",
            f"Analyze these habit patterns and provide personalized coaching. "
            f"Highlight strengths, weaknesses, and specific recommendations for improvement.\n\nHabits:\n{habit_summary}"
        )
        ai_result = self._call_engine(sys_prompt, habit_summary, temperature=0.4)
...
class ActivityWatcherDialog(BaseCapabilityDialog):
    ...
    def _aw_patterns(self):
        if not self._activities:
            ...
            return
        activity_summary = "\n".join(
            f"- [{a['timestamp'][:16]}] {a['type']}: {a['duration']}min, productivity={a['productivity']}"
            for a in self._activities
        )
        sys_prompt = self._build_capability_prompt(
            "Activity Tracker",
            f"Analyze these work activity patterns and provide insights on productivity, "
            f"optimal work times, and recommendations for improvement.\n\nActivities:\n{activity_summary}"
        )
        ai_result = self._call_engine(sys_prompt, activity_summary, temperature=0.4)
...
class APIIntegratorDialog(BaseCapabilityDialog):
    ...
    def _api_test(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "API Integrator",
            f"Analyze this API test request and provide guidance on expected response format, "
            f"potential issues, and recommended testing approach. Do NOT make actual HTTP requests."
        )
        user_prompt = f"API: {api['name']}\nURL: {full_url}\nMethod: {method}\nAuth: {api['auth']}"
        ai_result = self._call_engine(sys_prompt, user_prompt, temperature=0.3)
        self._api_test_output.setText(
            f"TEST REQUEST ANALYSIS\n{'='*60}\n"
            f"API: {api['name']}\nURL: {full_url}\nMethod: {method}\nAuth: {api['auth']}\n\n"
            f"{ai_result}\n\n"
...
class TranslationExpertDialog(BaseCapabilityDialog):
    ...
    def _te_translate(self):
        ...
        sys_prompt = self._build_capability_prompt("Translation Expert", f"Translate the following text from {src_lang} to {tgt_lang}. Provide only the translated text, preserving formatting and meaning. If the text contains specialized terminology, use the most accurate equivalent in the target language.")
        result = self._call_engine(sys_prompt, text, temperature=0.3)
...
class PresentationBuilderDialog(BaseCapabilityDialog):
    ...
    def _pb_generate(self):
        ...
        sys_prompt = self._build_capability_prompt(
            ...
            f"Create a presentation titled '{title}'. For each outline item, generate slide content with 3-5 bullet points "
            f"and suggested speaker notes. Format each slide as:\nSLIDE [number]: [title]\nBULLETS:\n- ...\nNOTES: ..."
        )
        result = self._call_engine(sys_prompt, outline, temperature=0.5)
...
class SpreadsheetWizardDialog(BaseCapabilityDialog):
    ...
    def _sw_calc(self):
        ...
        if ftype == "SUM":
            ...
            sys_prompt = self._build_capability_prompt(
                "Spreadsheet Wizard",
                f"Evaluate this custom spreadsheet formula or calculation request. "
                f"Explain the formula logic, provide the result if computable, and suggest alternatives."
            )
...
class LegalDocumentReviewerDialog(BaseCapabilityDialog):
    ...
    def _ldr_analyze(self):
        ...
        sys_prompt = self._build_capability_prompt(
            ...
            f"Analyze this {dtype} titled '{title}'. Identify key clauses (termination, liability, indemnification, "
            f"confidentiality, IP, payment, force majeure, dispute resolution, governing law, amendment). "
            f"Flag risky or unusual provisions. Assess balance of obligations. Note missing standard clauses. "
            f"This is informational analysis, NOT legal advice."
        )
        result = self._call_engine(sys_prompt, text, temperature=0.3)
        self._ldr_review_output.setText(
            ...
            f"{result}\n\n"
            f"RISK FLAGS:\n"
            f"  - This is NOT legal advice. Consult a licensed attorney.\n"
            f"  - Review all termination and liability clauses carefully.\n"
            f"  - Check governing law and dispute resolution terms.\n\n"
...
class MedicalResearcherDialog(BaseCapabilityDialog):
    ...
    def _mr_search(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Medical Researcher",
            f"Search medical literature for: {query}. Filter by study type: {study_type}. "
            f"Provide relevant study summaries, key findings, and cite source databases (PubMed, Cochrane, ClinicalTrials.gov). "
            f"Include study design, sample size, and confidence level where possible."
        )
        result = self._call_engine(sys_prompt, query, temperature=0.3)
        self._mr_search_output.setText(
            f"LITERATURE SEARCH\n{'='*60}\n"
            f"Query: {query}\nFilter: {study_type}\n\n"
            f"{result}\n\n"
            f"Recommended databases for verification:\n"
    ...
    def _mr_summarize(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Medical Researcher",
            f"Summarize this medical study. Title: {title}. "
            f"Extract key findings, methodology, sample size, limitations, and clinical relevance. "
            f"Grade the evidence level (A-D) and assess risk of bias."
        )
        result = self._call_engine(sys_prompt, abstract, temperature=0.3)
...
class AccessibilityAssistantDialog(BaseCapabilityDialog):
    ...
    def _aa_gen_alttext(self):
        ...
        sys_prompt = self._build_capability_prompt(
            ...
            "Generate concise, descriptive alt-text for an image based on the provided description or surrounding context. "
            "The alt-text should be max 125 characters, convey the purpose of the image, and avoid phrases like 'image of' or 'picture of'."
        )
        result = self._call_engine(sys_prompt, ctx, temperature=0.4)
        self._aa_alt_output.setText(
            f"ALT-TEXT SUGGESTION\n{'='*60}\n"
            f"AI-generated alt-text:\n\n"
            f"{result}\n\n"
            f"Tips:\n"
...
class FactCheckerDialog(BaseCapabilityDialog):
    ...
    def _fc_verify(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Fact Checker",
            f"Verify this claim in the category: {category}. "
            f"Assess veracity, identify supporting and contradicting evidence, flag potential bias, "
            f"and rate confidence (High/Medium/Low). Suggest primary sources for verification."
        )
        result = self._call_engine(sys_prompt, claim, temperature=0.3)
        self._fc_check_output.setText(
            f"FACT CHECK RESULT\n{'='*60}\n"
            f"Claim: {claim[:200]}\n"
            f"Category: {category}\n\n"
            f"{result}\n\n"
            f"RECOMMENDED VERIFICATION SOURCES:\n"
...
class VoiceInterfaceDialog(BaseCapabilityDialog):
    ...
    Uses VoiceManager for real local STT (faster-whisper, MIT) and TTS (OS-native).
    No cloud APIs. No GPL dependencies. All processing is local.
    """
    ...
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        ...
        self._vm.error.connect(self._on_voice_error)
        ...
        self._stt_status_label.setStyleSheet("color: #8b949e; font-size: 11px; padding: 2px;")
        layout.addWidget(self._stt_status_label)
        ...
        layout.addWidget(tabs, stretch=1)
        footer = QLabel("Voice interface uses local models (faster-whisper + OS-native TTS). No audio sent externally. License-free. Avery Logic Works is not liable.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)
    ...
    def _update_stt_status(self):
        stt = f"STT: {'Available' if self._vm.stt_available else 'Not Available'} ({self._vm.stt_backend})"
        tts = f"TTS: {'Available' if self._vm.tts_available else 'Not Available'}"
        self._stt_status_label.setText(f"{stt}  |  {tts}")
        self._vi_btn_record.setEnabled(self._vm.stt_available)
        self._vi_btn_speak.setEnabled(self._vm.tts_available)

    def _build_vi_stt_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Speech to Text (Local Whisper — MIT License)"))
        ...
        btn_row = QHBoxLayout()
        self._vi_btn_record = QPushButton("Start Recording")
        self._vi_btn_record.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        self._vi_btn_record.clicked.connect(self._vi_start_stt)
        btn_row.addWidget(self._vi_btn_record)

        self._vi_btn_stop_rec = QPushButton("Stop")
        self._vi_btn_stop_rec.setStyleSheet("background-color: #da3633; color: white; font-weight: bold; padding: 8px;")
        self._vi_btn_stop_rec.setEnabled(False)
        self._vi_btn_stop_rec.clicked.connect(self._vi_stop_stt)
        btn_row.addWidget(self._vi_btn_stop_rec)

        btn_row.addStretch()
        self._vi_btn_send = QPushButton("Send to AI")
        self._vi_btn_send.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        self._vi_btn_send.setEnabled(False)
        self._vi_btn_send.clicked.connect(self._vi_send_to_ai)
        btn_row.addWidget(self._vi_btn_send)
    ...
    def _build_vi_tts_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Text to Speech (OS-Native — No External Dependencies)"))
        ...
        btn_row = QHBoxLayout()
        self._vi_btn_speak = QPushButton("Speak")
        self._vi_btn_speak.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        self._vi_btn_speak.clicked.connect(self._vi_speak)
        btn_row.addWidget(self._vi_btn_speak)

        self._vi_btn_stop_speak = QPushButton("Stop")
        self._vi_btn_stop_speak.setStyleSheet("background-color: #da3633; color: white; font-weight: bold; padding: 8px;")
        self._vi_btn_stop_speak.clicked.connect(self._vi_stop_speaking)
        btn_row.addWidget(self._vi_btn_stop_speak)
        ...
        self._vi_tts_output.setMaximumHeight(80)
    ...
    def _build_vi_commands_tab(self):
        ...
        ref.setText(
            ...
            "All processing is local — no audio sent to external servers."
        )
        l.addWidget(ref, stretch=1)
        return w
    ...
    def _vi_start_stt(self):
        if not self._vm.stt_available:
            self._vi_stt_output.setText("Speech recognition not available. Install faster-whisper and ensure model files exist.")
            return
        self._vi_stt_output.setPlainText("Listening... Speak now.")
        self._vm.listen_once()

    def _vi_stop_stt(self):
        self._vm.stop_listening()

    def _vi_send_to_ai(self):
        text = self._vi_stt_output.toPlainText().strip()
        if text and text != "Listening... Speak now.":
            self.voice_command_ready.emit(text)
            self._vi_stt_output.setPlainText(f"[Sent to AI]: {text}")
    ...
    def _vi_speak(self):
        ...
        if not text:
            ...
            return
        if not self._vm.tts_available:
            self._vi_tts_output.setText("TTS not available on this system.")
            return
        entry = {"id": len(self._voice_log) + 1, "type": "TTS", "text": text, "created": datetime.now().isoformat()}
    ...
    def _vi_stop_speaking(self):
        ...
        self._vi_tts_output.setText("Speech stopped.")

    def _on_transcription(self, text: str):
        self._vi_stt_output.setPlainText(text)
        self._vi_btn_send.setEnabled(bool(text.strip()))

    def _on_partial_transcription(self, text: str):
        current = self._vi_stt_output.toPlainText()
        if current and current != "Listening... Speak now.":
            self._vi_stt_output.setPlainText(current + " " + text)
        else:
            self._vi_stt_output.setPlainText(text)

    def _on_listening_started(self):
        self._vi_btn_record.setEnabled(False)
        self._vi_btn_stop_rec.setEnabled(True)
        self._vi_stt_output.setPlainText("Listening... Speak now.")

    def _on_listening_stopped(self):
        self._vi_btn_record.setEnabled(self._vm.stt_available)
        self._vi_btn_stop_rec.setEnabled(False)
        if not self._vi_stt_output.toPlainText().strip() or self._vi_stt_output.toPlainText().strip() == "Listening... Speak now.":
            self._vi_stt_output.setPlainText("No speech detected.")

    def _on_tts_started(self):
        self._vi_btn_speak.setEnabled(False)
        self._vi_btn_speak.setText("Speaking...")

    def _on_tts_finished(self):
        self._vi_btn_speak.setEnabled(self._vm.tts_available)
        self._vi_btn_speak.setText("Speak")
        if self._vi_tts_output.toPlainText().startswith("Speaking"):
            self._vi_tts_output.setText("Speech complete.")

    def _on_voice_error(self, msg: str):
        self._vi_tts_output.setText(f"Error: {msg}")
        self._vi_stt_output.setPlainText(f"Error: {msg}")
        self._vi_btn_record.setEnabled(self._vm.stt_available)
        self._vi_btn_stop_rec.setEnabled(False)
        self._vi_btn_speak.setEnabled(self._vm.tts_available)
        self._vi_btn_speak.setText("Speak")
...
class WorkflowAutomatorDialog(BaseCapabilityDialog):
    ...
    def _wa_save(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Workflow Automator",
            f"Analyze this workflow '{name}' and suggest optimizations, potential bottlenecks, "
            f"automation opportunities, and error-handling improvements for each step."
        )
        result = self._call_engine(sys_prompt, steps_raw, temperature=0.4)
        self._wa_builder_output.setText(
            f"Workflow saved: [{wf['id']}] {name}\n  Steps: {len(steps)}\n  Total workflows: {len(self._workflows)}\n\n"
            f"AI OPTIMIZATION SUGGESTIONS:\n{'='*60}\n{result}"
        )
        self._wa_name.clear()
...
class CompetitiveAnalystDialog(BaseCapabilityDialog):
    ...
    def _ca_gen_swot(self):
        ...
        if not subject:
            ...
            return
        swot_input = f"Strengths: {s or '(none listed)'}\nWeaknesses: {w or '(none listed)'}\nOpportunities: {o or '(none listed)'}\nThreats: {t or '(none listed)'}"
        sys_prompt = self._build_capability_prompt(
            "Competitive Analyst",
            f"Generate a strategic SWOT analysis for '{subject}'. Based on the provided inputs, "
            f"develop strategic insights: SO strategy (leverage strengths for opportunities), WT strategy (address weaknesses to avoid threats), "
            f"ST strategy (use strengths to mitigate threats), WO strategy (improve weaknesses to pursue opportunities). "
            f"Provide actionable recommendations."
        )
        result = self._call_engine(sys_prompt, swot_input, temperature=0.5)
...
class LearningPathCreatorDialog(BaseCapabilityDialog):
    ...
    def _lp_create(self):
        ...
        sys_prompt = self._build_capability_prompt(
            ...
            f"Create a detailed learning path for '{title}' at {level} level. "
            f"For each milestone, provide recommended resources, estimated time, and learning objectives. "
            f"Suggest projects or exercises to reinforce learning at each stage."
        )
        result = self._call_engine(sys_prompt, milestones_raw, temperature=0.5)
        self._lp_create_output.setText(
            f"Learning path saved: [{path['id']}] {title}\n"
            f"  Level: {level}\n  Milestones: {len(milestones)}\n  Total paths: {len(self._paths)}\n\n"
            f"AI-GENERATED LEARNING PLAN:\n{'='*60}\n{result}"
        )
...
class SmartSearchDialog(BaseCapabilityDialog):
    ...
    def _ss_search(self):
        ...
        sys_prompt = self._build_capability_prompt(
            "Smart Search",
            f"Search scope: {scope}. Provide comprehensive, well-ranked results for the query. "
            f"Include relevant sources, key information, and context. Rank by relevance."
        )
        result = self._call_engine(sys_prompt, query, temperature=0.4)
...
class WellnessCoachDialog(BaseCapabilityDialog):
    """Wellness Coach — fitness planner, nutrition advisor, mental wellness guide, habit builder, progress tracker."""

    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Wellness Coach — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        self._fitness_log: list[dict] = []
        self._habit_log: list[dict] = []
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        banner.setWordWrap(True)
        ...
        tabs = QTabWidget()
        tabs.setStyleSheet("QTabWidget::pane { border: 1px solid #30363d; } QTabBar::tab { background: #161b22; color: #8b949e; padding: 8px 16px; } QTabBar::tab:selected { background: #0d1117; color: #58a6ff; border-bottom: 2px solid #1f6feb; }")
        tabs.addTab(self._build_fitness_tab(), "Fitness Planner")
        tabs.addTab(self._build_nutrition_tab(), "Nutrition Advisor")
        tabs.addTab(self._build_wellness_tab(), "Mental Wellness")
        tabs.addTab(self._build_habit_tab(), "Habit Builder")
        tabs.addTab(self._build_progress_tab(), "Progress Tracker")
        layout.addWidget(tabs, stretch=1)
        footer = QLabel("Wellness Coach provides advisory guidance only. Not a substitute for professional medical advice. Always consult a healthcare provider. Avery Logic Works is not liable.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)
    ...
    def _build_fitness_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Fitness Planner"))
        l.addWidget(QLabel("Your current fitness level:"))
        self._fitness_level = QComboBox()
        self._fitness_level.addItems(["Sedentary", "Beginner", "Intermediate", "Advanced", "Athlete"])
        l.addWidget(self._fitness_level)
        l.addWidget(QLabel("Primary goal:"))
        self._fitness_goal = QComboBox()
        self._fitness_goal.addItems(["General fitness", "Weight loss", "Muscle gain", "Endurance", "Flexibility", "Stress reduction"])
        l.addWidget(self._fitness_goal)
        l.addWidget(QLabel("Available days per week:"))
        self._fitness_days = QComboBox()
        self._fitness_days.addItems(["1", "2", "3", "4", "5", "6", "7"])
        l.addWidget(self._fitness_days)
        l.addWidget(QLabel("Session length (minutes):"))
        self._fitness_duration = QComboBox()
        self._fitness_duration.addItems(["15", "30", "45", "60", "90"])
        l.addWidget(self._fitness_duration)
        btn = QPushButton("Generate Fitness Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_fitness_plan)
        l.addWidget(btn)
        self._fitness_output = QTextEdit()
        self._fitness_output.setReadOnly(True)
        l.addWidget(self._fitness_output, stretch=1)
        return w

    def _build_nutrition_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Nutrition Advisor"))
        l.addWidget(QLabel("Dietary preference:"))
        self._nutrition_diet = QComboBox()
        self._nutrition_diet.addItems(["No restrictions", "Vegetarian", "Vegan", "Pescatarian", "Keto", "Mediterranean", "Gluten-free", "Low-carb"])
        l.addWidget(self._nutrition_diet)
        l.addWidget(QLabel("Daily calorie target (approximate):"))
        self._nutrition_calories = QLineEdit()
        self._nutrition_calories.setPlaceholderText("e.g., 2000 (leave blank for auto-estimate)")
        l.addWidget(self._nutrition_calories)
        l.addWidget(QLabel("Meals per day:"))
        self._nutrition_meals = QComboBox()
        self._nutrition_meals.addItems(["2", "3", "4", "5", "6"])
        l.addWidget(self._nutrition_meals)
        btn = QPushButton("Generate Meal Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_nutrition_plan)
        l.addWidget(btn)
        self._nutrition_output = QTextEdit()
        self._nutrition_output.setReadOnly(True)
        l.addWidget(self._nutrition_output, stretch=1)
        return w

    def _build_wellness_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Mental Wellness Guide"))
        l.addWidget(QLabel("How are you feeling right now?"))
        self._wellness_mood = QComboBox()
        self._wellness_mood.addItems(["Great", "Good", "Okay", "Stressed", "Anxious", "Low energy", "Burned out", "Overwhelmed"])
        l.addWidget(self._wellness_mood)
        l.addWidget(QLabel("What's on your mind? (optional)"))
        self._wellness_input = QTextEdit()
        self._wellness_input.setPlaceholderText("Describe what's bothering you or what you'd like support with...")
        self._wellness_input.setMaximumHeight(80)
        l.addWidget(self._wellness_input)
        btn = QPushButton("Get Wellness Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_wellness_guidance)
        l.addWidget(btn)
        self._wellness_output = QTextEdit()
        self._wellness_output.setReadOnly(True)
        l.addWidget(self._wellness_output, stretch=1)
        return w

    def _build_habit_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Habit Builder"))
        l.addWidget(QLabel("Habit you want to build:"))
        self._habit_name = QLineEdit()
        self._habit_name.setPlaceholderText("e.g., Drink 8 glasses of water, Read 20 minutes, Meditate 10 minutes...")
        l.addWidget(self._habit_name)
        l.addWidget(QLabel("Frequency:"))
        self._habit_freq = QComboBox()
        self._habit_freq.addItems(["Daily", "Weekdays", "3x per week", "Weekly"])
        l.addWidget(self._habit_freq)
        l.addWidget(QLabel("Target duration (days to establish):"))
        self._habit_duration = QComboBox()
        self._habit_duration.addItems(["7", "21", "30", "60", "90"])
        l.addWidget(self._habit_duration)
        btn = QPushButton("Create Habit Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_habit_plan)
        l.addWidget(btn)
        log_btn = QPushButton("Log Habit Completion")
        log_btn.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        log_btn.clicked.connect(self._run_habit_log)
        l.addWidget(log_btn)
        show_btn = QPushButton("Show Habit Summary")
        show_btn.setStyleSheet("background-color: #238636; color: white; font-weight: bold; padding: 8px;")
        show_btn.clicked.connect(self._run_habit_summary)
        l.addWidget(show_btn)
        self._habit_output = QTextEdit()
        self._habit_output.setReadOnly(True)
        l.addWidget(self._habit_output, stretch=1)
        return w
    ...
    def _build_progress_tab(self):
        ...
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Progress Tracker"))
        l.addWidget(QLabel("Log a workout or wellness activity:"))
        row = QHBoxLayout()
        row.addWidget(QLabel("Activity:"))
        self._progress_activity = QLineEdit()
        self._progress_activity.setPlaceholderText("e.g., 30min run, yoga session, meditation...")
        row.addWidget(self._progress_activity)
        row.addWidget(QLabel("Duration (min):"))
        self._progress_duration = QLineEdit()
        self._progress_duration.setPlaceholderText("e.g., 30")
        self._progress_duration.setMaximumWidth(60)
        row.addWidget(self._progress_duration)
        row.addStretch()
        l.addLayout(row)
        l.addWidget(QLabel("Notes (how you felt, what you noticed):"))
        self._progress_notes = QTextEdit()
        self._progress_notes.setMaximumHeight(60)
        l.addWidget(self._progress_notes)
        btn = QPushButton("Log Activity")
    ...
    def _run_fitness_plan(self):
        level = self._fitness_level.currentText()
        goal = self._fitness_goal.currentText()
        days = self._fitness_days.currentText()
        duration = self._fitness_duration.currentText()
        task = f"Create a {level} fitness plan for {goal}. {days} days per week, {duration} min per session. Include exercises, sets/reps, rest, and weekly progression."
        sys_prompt = self._build_capability_prompt("Wellness Coach", task, extra_context=f"Level: {level}, Goal: {goal}")
        result = self._call_engine(sys_prompt, task, temperature=0.6)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._fitness_output.setText(result)
            self._set_result_summary(f"Fitness plan: {goal} for {level}.")
            return
        plans = {
            "Sedentary": [("Walk 15 min + stretch 10 min",), ("Walk 20 min + bodyweight squats 2x8",), ("Walk 25 min + stretch",), ("Rest or light yoga 15 min",)],
            "Beginner": [("Walk/jog 20 min, pushups 3x8, squats 3x10, plank 3x20s",), ("Rest or yoga 20 min",), ("Walk/jog 25 min, lunges 3x8, sit-ups 3x12",), ("Circuit: jacks 30s, squats 12, pushups 8, plank 30s x3",)],
            "Intermediate": [("Run 30 min, pushups 4x15, pull-ups 3x8, squats 4x15",), ("Yoga/recovery 30 min",), ("Intervals 25 min + core 15 min",), ("Run 35 min, lunges 4x12, plank 4x45s",)],
            "Advanced": [("Bench 5x5, incline DB 4x8, dips 4x10",), ("Pull-ups 5x8, rows 4x8, curls 4x10",), ("Squat 5x5, RDL 4x8, lunges 4x10",), ("OHP 5x5, lateral raises 4x12, core 4x12",)],
            "Athlete": [("Long run 60 min easy",), ("Tempo 35 min + strides",), ("Track: 800m x5, 2 min rest",), ("Easy 40 min + core 15 min",)],
        }
        workouts = plans.get(level, plans["Beginner"])
        output = f"[FITNESS PLAN — LOCAL]\n\nLevel: {level}\nGoal: {goal}\nFrequency: {days}x/week, {duration} min/session\n\n"
        for i, (workout,) in enumerate(workouts, 1):
            output += f"  Session {i}: {workout}\n"
        output += (
            "\nPROGRESSION:\n  - Increase intensity 5-10% every 2 weeks\n"
            "  - Deload week every 4-6 weeks\n  - Rest when needed\n\n"
            "WARM-UP: 5 min light cardio + dynamic stretching\n"
            "COOL-DOWN: 5 min walking + static stretching\n\n"
            "The built-in intelligence can provide personalized plans."
        )
        self._fitness_output.setText(output)
        self._set_result_summary(f"Fitness plan: {goal} for {level}.")

    def _run_nutrition_plan(self):
        diet = self._nutrition_diet.currentText()
        calories = self._nutrition_calories.text().strip() or "2000"
        meals = self._nutrition_meals.currentText()
        task = f"Create a {diet} meal plan, ~{calories} cal/day, {meals} meals. Include foods, portions, and nutrition breakdown."
        sys_prompt = self._build_capability_prompt("Wellness Coach", task, extra_context=f"Diet: {diet}, Calories: {calories}")
        result = self._call_engine(sys_prompt, task, temperature=0.6)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._nutrition_output.setText(result)
            self._set_result_summary(f"Meal plan: {diet}, ~{calories} cal.")
            return
        templates = {
            "No restrictions": [("Breakfast", "Oatmeal w/ berries & honey, 2 eggs"), ("Lunch", "Grilled chicken salad, olive oil dressing"), ("Dinner", "Salmon, quinoa, roasted vegetables"), ("Snack", "Greek yogurt + almonds")],
            "Vegetarian": [("Breakfast", "Veggie scramble: eggs, spinach, peppers, feta"), ("Lunch", "Quinoa bowl: black beans, avocado, salsa"), ("Dinner", "Tofu stir-fry w/ broccoli, brown rice"), ("Snack", "Hummus + carrot sticks")],
            "Vegan": [("Breakfast", "Overnight oats: almond milk, chia, berries"), ("Lunch", "Chickpea salad w/ lemon-tahini dressing"), ("Dinner", "Lentil curry w/ brown rice, steamed broccoli"), ("Snack", "Apple + 2 tbsp peanut butter")],
            "Keto": [("Breakfast", "3 eggs, avocado, bacon, coffee w/ cream"), ("Lunch", "Chicken thigh salad w/ olive oil, cheese"), ("Dinner", "Ribeye steak, asparagus w/ butter"), ("Snack", "Macadamia nuts, cheese cubes")],
            "Mediterranean": [("Breakfast", "Greek yogurt w/ honey, walnuts, berries"), ("Lunch", "Grilled fish, couscous, Greek salad"), ("Dinner", "Lamb w/ roasted vegetables, olive oil"), ("Snack", "Olives + feta cheese")],
        }
        meal_list = templates.get(diet, templates["No restrictions"])
        output = f"[MEAL PLAN — LOCAL]\n\nDiet: {diet}\nTarget: ~{calories} cal/day\nMeals: {meals}/day\n\n"
        for meal_name, meal_desc in meal_list[:int(meals)]:
            output += f"  {meal_name}: {meal_desc}\n"
        output += (
            "\nNUTRITION TIPS:\n"
            ...
            "The built-in intelligence can provide personalized meal plans."
        )
        self._nutrition_output.setText(output)
        self._set_result_summary(f"Meal plan: {diet}, ~{calories} cal.")

    def _run_wellness_guidance(self):
        mood = self._wellness_mood.currentText()
        user_input = self._wellness_input.toPlainText().strip()
        task = f"Provide mental wellness guidance for someone feeling {mood}. Context: {user_input or 'No additional context provided.'}"
        sys_prompt = self._build_capability_prompt("Wellness Coach", task, extra_context=f"Mood: {mood}")
        result = self._call_engine(sys_prompt, task, temperature=0.7)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._wellness_output.setText(result)
            self._set_result_summary(f"Wellness guidance for mood: {mood}.")
            return
        guidance = {
            "Great": "You're feeling great! Channel this energy into something meaningful.\n\nSUGGESTIONS:\n  - Take on a creative project or help someone\n  - Try a new physical activity while energy is high\n  - Journal what's going well to revisit on harder days\n  - Share your positivity with others",
            "Good": "You're in a good headspace. Keep the momentum going.\n\nSUGGESTIONS:\n  - Maintain your routines\n  - Do something you enjoy\n  - Connect with a friend or family member\n  - Plan something to look forward to",
            "Okay": "A neutral day is fine. Small actions can shift the needle.\n\nSUGGESTIONS:\n  - Take a 10-minute walk outside\n  - Do one small thing that gives you satisfaction\n  - Listen to music you enjoy\n  - Check in with yourself: what would make today better?",
            "Stressed": "Stress is your body asking for attention. Let's work with it.\n\nBREATHING EXERCISE (4-7-8):\n  1. Inhale through nose for 4 counts\n  2. Hold for 7 counts\n  3. Exhale through mouth for 8 counts\n  4. Repeat 3-4 times\n\nACTION STEPS:\n  - Write down what's stressing you — naming it reduces its power\n  - Break overwhelming tasks into small steps\n  - Take a 15-minute walk to reset\n  - Limit caffeine and drink water\n  - Do one thing you can control right now",
            "Anxious": "Anxiety thrives on uncertainty. Grounding can help.\n\n5-4-3-2-1 GROUNDING:\n  - Name 5 things you can see\n  - Name 4 things you can touch\n  - Name 3 things you can hear\n  - Name 2 things you can smell\n  - Name 1 thing you can taste\n\nACTION STEPS:\n  - Box breathing: inhale 4, hold 4, exhale 4, hold 4 — repeat 5 times\n  - Remind yourself: feelings are not facts\n  - Limit news and social media input\n  - Physical grounding: press feet into the floor\n  - If anxiety persists or interferes with daily life, consider talking to a professional",
            "Low energy": "Low energy can have many causes. Let's address it gently.\n\nENERGY STRATEGIES:\n  - Drink a glass of water (dehydration causes fatigue)\n  - Get 10 minutes of sunlight or bright light\n  - Stand up and stretch for 2 minutes\n  - Eat something with protein and complex carbs\n  - Check your sleep quality — are you getting 7-9 hours?\n  - Consider: iron, B12, or vitamin D levels (see a doctor for bloodwork)\n  - If persistent, consult a healthcare provider",
            "Burned out": "Burnout is your system saying 'I need rest, not more effort.'\n\nRECOVERY STEPS:\n  - Identify what's draining you most — write it down\n  - Set one boundary this week (say no to something)\n  - Schedule non-negotiable rest time\n  - Disconnect from work/screens for a set period\n  - Do something purely for enjoyment — no productivity goal\n  - Talk to someone you trust about how you're feeling\n  - If burnout is work-related, consider discussing workload with your manager\n  - Professional counseling can help with chronic burnout",
            "Overwhelmed": "Overwhelm happens when everything feels urgent. Let's triage.\n\nTRIAGE METHOD:\n  1. Write down EVERYTHING on your mind — get it out of your head\n  2. Mark each item: URGENT (must do today), IMPORTANT (this week), LATER\n  3. Pick ONE urgent item — just one — and start it\n  4. Set a timer for 15 minutes and work on only that\n  5. When timer ends, check in: continue or switch?\n\nREMINDERS:\n  - You don't have to do everything at once\n  - Done is better than perfect\n  - Ask for help — delegation is a skill, not weakness\n  - Take a 5-minute breather before continuing",
        }
        output = f"[MENTAL WELLNESS — LOCAL GUIDANCE]\n\nMood: {mood}\n"
        if user_input:
            output += f"Context: {user_input[:200]}\n"
        output += f"\n{guidance.get(mood, guidance['Okay'])}\n\n"
        output += (
            "IMPORTANT: This is advisory support, not therapy or medical advice.\n"
            "If you're experiencing persistent distress, please contact a mental health professional.\n"
            "Crisis line: 988 (US) or your local emergency number.\n\n"
            "The built-in intelligence can provide more personalized guidance."
        )
        self._wellness_output.setText(output)
        self._set_result_summary(f"Wellness guidance for: {mood}.")

    def _run_habit_plan(self):
        habit = self._habit_name.text().strip()
        if not habit:
            self._habit_output.setText("Enter a habit to build.")
            return
        freq = self._habit_freq.currentText()
        duration_days = self._habit_duration.currentText()
        task = f"Create a {duration_days}-day habit building plan for: {habit}. Frequency: {freq}. Include milestones, triggers, and accountability strategies."
        sys_prompt = self._build_capability_prompt("Wellness Coach", task, extra_context=f"Habit: {habit}, Frequency: {freq}")
        result = self._call_engine(sys_prompt, task, temperature=0.6)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._habit_output.setText(result)
            self._set_result_summary(f"Habit plan: {habit} for {duration_days} days.")
            return
        output = (
            f"[HABIT BUILDING PLAN — LOCAL]\n\n"
        ...
        phases = [
            ("Days 1-7", "Focus on consistency over perfection. Do the habit even if briefly. Track daily."),
            ("Days 8-14", "Increase duration/intensity slightly. Notice triggers that help or hinder."),
            ("Days 15-21", "The habit should feel more automatic. Experiment with making it easier."),
            ("Days 22-30", "Solidify the routine. Plan for obstacles and setbacks."),
            ("Days 31-60", "Maintenance phase. The habit is becoming part of your identity."),
            ("Days 61-90", "Long-term integration. Consider stacking another habit on top."),
        ]
        for phase_name, phase_desc in phases:
            output += f"  {phase_name}: {phase_desc}\n"
        output += (
            "\nSUCCESS STRATEGIES:\n"
            "  - Start ridiculously small (2 minutes minimum)\n"
            "  - Never miss twice — one miss is an accident, two is a new pattern\n"
            "  - Track visually (calendar, app, journal)\n"
            "  - Reward yourself for streaks\n"
            "  - Tell someone — accountability doubles success rate\n"
            "  - Plan for obstacles: 'If X happens, I will Y instead'\n"
            "  - Environment design: make the habit easy, the bad habit hard\n\n"
            "The built-in intelligence can provide personalized habit plans."
        )
        self._habit_output.setText(output)
        self._set_result_summary(f"Habit plan: {habit}, {duration_days} days.")

    def _run_habit_log(self):
        habit = self._habit_name.text().strip()
        if not habit:
            self._habit_output.setText("Enter a habit name first.")
            return
        entry = {"habit": habit, "date": datetime.now().isoformat()[:10], "completed": True}
        self._habit_log.append(entry)
        self._habit_output.setText(f"Habit logged: {habit} — {entry['date']}\nTotal completions: {len(self._habit_log)}")
        self._set_result_summary(f"Habit logged: {habit}.")

    def _run_habit_summary(self):
        if not self._habit_log:
            self._habit_output.setText("No habits logged yet.")
            return
        output = f"HABIT SUMMARY\n{'='*40}\n{len(self._habit_log)} completions:\n\n"
        for entry in self._habit_log:
            output += f"  {entry['date']} — {entry['habit']}\n"
        output += f"\nKeep going! Consistency builds identity."
        self._habit_output.setText(output)
        self._set_result_summary(f"Habit summary: {len(self._habit_log)} completions.")

    def _run_progress_log(self):
        activity = self._progress_activity.text().strip()
        if not activity:
            self._progress_output.setText("Enter an activity name.")
            return
        duration = self._progress_duration.text().strip() or "—"
        notes = self._progress_notes.toPlainText().strip()
        entry = {"activity": activity, "duration": duration, "notes": notes, "date": datetime.now().isoformat()[:10]}
        self._fitness_log.append(entry)
        self._progress_activity.clear()
        self._progress_duration.clear()
        self._progress_notes.clear()
        self._progress_output.setText(f"Activity logged: {activity} ({duration} min) — {entry['date']}\nTotal activities: {len(self._fitness_log)}")
        self._set_result_summary(f"Activity logged: {activity}.")

    def _run_progress_summary(self):
        if not self._fitness_log:
            self._progress_output.setText("No activities logged yet.")
            return
        output = f"WELLNESS PROGRESS SUMMARY\n{'='*40}\n{len(self._fitness_log)} activities:\n\n"
        total_min = 0
        for entry in self._fitness_log:
            dur = entry["duration"]
            output += f"  {entry['date']} — {entry['activity']} ({dur} min)"
            if entry["notes"]:
                output += f" — {entry['notes'][:60]}"
            output += "\n"
            try:
                total_min += int(dur)
            except ValueError:
        ...
        output += f"Average per session: {total_min // len(self._fitness_log) if self._fitness_log else 0} minutes\n"
        output += "\nKeep tracking! Awareness is the first step to improvement."
        self._progress_output.setText(output)
        self._set_result_summary(f"Progress summary: {len(self._fitness_log)} activities.")


class ContentStrategistDialog(BaseCapabilityDialog):
    """Content Strategist — content calendar, audience analysis, platform optimization, repurposing, brand voice."""

    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Content Strategist — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        tabs = QTabWidget()
        tabs.setStyleSheet("QTabWidget::pane { border: 1px solid #30363d; } QTabBar::tab { background: #161b22; color: #8b949e; padding: 8px 16px; } QTabBar::tab:selected { background: #0d1117; color: #58a6ff; border-bottom: 2px solid #1f6feb; }")
        tabs.addTab(self._build_calendar_tab(), "Content Calendar")
        tabs.addTab(self._build_audience_tab(), "Audience Analyzer")
        tabs.addTab(self._build_platform_tab(), "Platform Optimizer")
    ...
    def _build_calendar_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Content Calendar Planner"))
        l.addWidget(QLabel("Content topic or theme:"))
        self._cal_topic = QLineEdit()
        self._cal_topic.setPlaceholderText("e.g., AI tools, healthy recipes, dev tutorials...")
        l.addWidget(self._cal_topic)
        l.addWidget(QLabel("Posting frequency:"))
        self._cal_freq = QComboBox()
        self._cal_freq.addItems(["Daily", "3x/week", "2x/week", "Weekly", "Bi-weekly"])
        l.addWidget(self._cal_freq)
        l.addWidget(QLabel("Primary platform:"))
        self._cal_platform = QComboBox()
        self._cal_platform.addItems(["Blog", "YouTube", "Instagram", "LinkedIn", "Twitter/X", "TikTok", "Podcast", "Multi-platform"])
        l.addWidget(self._cal_platform)
        l.addWidget(QLabel("Weeks to plan:"))
        self._cal_weeks = QComboBox()
        self._cal_weeks.addItems(["1", "2", "4", "8", "12"])
        l.addWidget(self._cal_weeks)
        btn = QPushButton("Generate Calendar")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_calendar)
        l.addWidget(btn)
        self._cal_output = QTextEdit()
        self._cal_output.setReadOnly(True)
        l.addWidget(self._cal_output, stretch=1)
        return w

    def _build_audience_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Audience Analyzer"))
        l.addWidget(QLabel("Your niche or industry:"))
        self._aud_niche = QLineEdit()
        self._aud_niche.setPlaceholderText("e.g., indie game dev, personal finance, fitness coaching...")
        l.addWidget(self._aud_niche)
        l.addWidget(QLabel("Target audience description:"))
        self._aud_desc = QTextEdit()
        self._aud_desc.setPlaceholderText("Describe your ideal audience: age, interests, pain points...")
        self._aud_desc.setMaximumHeight(80)
        l.addWidget(self._aud_desc)
        btn = QPushButton("Analyze Audience")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_audience)
        l.addWidget(btn)
        self._aud_output = QTextEdit()
        self._aud_output.setReadOnly(True)
        l.addWidget(self._aud_output, stretch=1)
        return w

    def _build_platform_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Platform Optimizer"))
        l.addWidget(QLabel("Platform:"))
        self._plat_name = QComboBox()
        self._plat_name.addItems(["Blog/SEO", "YouTube", "Instagram", "LinkedIn", "Twitter/X", "TikTok", "Email Newsletter", "Podcast"])
        l.addWidget(self._plat_name)
        l.addWidget(QLabel("Your content (paste or describe):"))
        self._plat_content = QTextEdit()
        self._plat_content.setPlaceholderText("Paste your content or describe what you want to post...")
        self._plat_content.setMaximumHeight(100)
        l.addWidget(self._plat_content)
        btn = QPushButton("Optimize for Platform")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_platform_opt)
        l.addWidget(btn)
        self._plat_output = QTextEdit()
        self._plat_output.setReadOnly(True)
        l.addWidget(self._plat_output, stretch=1)
        return w

    def _build_repurpose_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Content Repurposing Engine"))
        l.addWidget(QLabel("Paste your original content:"))
        self._repurpose_input = QTextEdit()
        self._repurpose_input.setPlaceholderText("Paste your original content here...")
        l.addWidget(self._repurpose_input, stretch=1)
        from PySide6.QtWidgets import QCheckBox, QGridLayout
        l.addWidget(QLabel("Target platforms:"))
        grid = QGridLayout()
        self._repurpose_checks: dict[str, QCheckBox] = {}
        platforms = ["Twitter/X thread", "LinkedIn post", "Instagram caption", "TikTok script", "YouTube description", "Email newsletter", "Blog summary"]
        for i, p in enumerate(platforms):
            cb = QCheckBox(p)
            self._repurpose_checks[p] = cb
            grid.addWidget(cb, i // 2, i % 2)
        l.addLayout(grid)
        btn = QPushButton("Repurpose Content")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_repurpose)
        l.addWidget(btn)
        self._repurpose_output = QTextEdit()
        self._repurpose_output.setReadOnly(True)
        l.addWidget(self._repurpose_output, stretch=1)
        return w

    def _build_brandvoice_tab(self):
        w = QWidget()
        l = QVBoxLayout(w)
        l.addWidget(QLabel("Brand Voice Tuner"))
        l.addWidget(QLabel("Describe your brand or personal style:"))
        self._brand_desc = QTextEdit()
        self._brand_desc.setPlaceholderText("e.g., Professional but approachable, witty, warm and educational...")
        self._brand_desc.setMaximumHeight(60)
        l.addWidget(self._brand_desc)
        from PySide6.QtWidgets import QCheckBox, QGridLayout
        l.addWidget(QLabel("Tone attributes:"))
        grid = QGridLayout()
        self._brand_checks: dict[str, QCheckBox] = {}
        tones = ["Professional", "Casual", "Humorous", "Authoritative", "Empathetic", "Bold", "Educational", "Inspirational", "Minimalist", "Conversational"]
        for i, t in enumerate(tones):
            cb = QCheckBox(t)
            self._brand_checks[t] = cb
            grid.addWidget(cb, i // 2, i % 2)
        l.addLayout(grid)
        l.addWidget(QLabel("Sample topic to test voice:"))
        self._brand_topic = QLineEdit()
        self._brand_topic.setPlaceholderText("e.g., Why you should start meditating today")
        l.addWidget(self._brand_topic)
        btn = QPushButton("Generate Brand Voice Guide")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_brand_voice)
        l.addWidget(btn)
        self._brand_output = QTextEdit()
        self._brand_output.setReadOnly(True)
        l.addWidget(self._brand_output, stretch=1)
        return w

    def _run_calendar(self):
        topic = self._cal_topic.text().strip()
        if not topic:
            self._cal_output.setText("Enter a content topic.")
            return
        freq = self._cal_freq.currentText()
        platform = self._cal_platform.currentText()
        weeks = int(self._cal_weeks.currentText())
        task = f"Create a {weeks}-week content calendar about {topic}. Frequency: {freq}. Platform: {platform}. Include post titles, content types, and angles."
        sys_prompt = self._build_capability_prompt("Content Strategist", task, extra_context=f"Topic: {topic}, Platform: {platform}")
        result = self._call_engine(sys_prompt, task, temperature=0.7)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._cal_output.setText(result)
            self._set_result_summary(f"Content calendar: {topic}, {weeks} weeks.")
            return
        freq_map = {"Daily": 7, "3x/week": 3, "2x/week": 2, "Weekly": 1, "Bi-weekly": 0}
        ppw = freq_map.get(freq, 3)
        total = int(ppw * weeks)
        ctypes = ["How-to guide", "Listicle", "Case study", "Opinion piece", "Q&A/FAQ", "Behind-the-scenes", "Tutorial", "Roundup", "Story", "Data/infographic"]
        angles = ["Beginner intro", "Common mistakes", "Advanced technique", "Personal experience", "Myth-busting", "Tools/resources", "Quick tips", "Deep dive", "Comparison", "Future trends"]
        output = f"[CONTENT CALENDAR — LOCAL]\n\nTopic: {topic}\nPlatform: {platform}\nFrequency: {freq}\nWeeks: {weeks}\nTotal posts: {total}\n\n"
        n = 0
        for wk in range(1, weeks + 1):
            output += f"--- WEEK {wk} ---\n"
            for _ in range(int(ppw)):
                n += 1
                output += f"  Post {n}: [{ctypes[n % len(ctypes)]}] {topic}: {angles[n % len(angles)]}\n"
            output += "\n"
        output += (
            "CONTENT MIX:\n"
            "  40% educational, 30% engagement, 20% promotional, 10% curated\n\n"
            "BEST PRACTICES:\n"
            "  - Batch create and schedule\n  - Repurpose across 2-3 platforms\n"
            "  - Track engagement and adjust\n  - Stay consistent\n\n"
            "The built-in intelligence can provide a personalized calendar."
        )
        self._cal_output.setText(output)
        self._set_result_summary(f"Content calendar: {topic}, {total} posts.")

    def _run_audience(self):
        niche = self._aud_niche.text().strip()
        desc = self._aud_desc.toPlainText().strip()
        if not niche:
            self._aud_output.setText("Enter your niche or industry.")
            return
        task = f"Analyze the target audience for: {niche}. Description: {desc or 'General'}. Include demographics, pain points, content preferences, engagement strategies."
        sys_prompt = self._build_capability_prompt("Content Strategist", task, extra_context=f"Niche: {niche}")
        result = self._call_engine(sys_prompt, task, temperature=0.7)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._aud_output.setText(result)
            self._set_result_summary(f"Audience analysis: {niche}.")
            return
        output = (
            f"[AUDIENCE ANALYSIS — LOCAL]\n\nNiche: {niche}\nDescription: {desc[:200] if desc else 'General'}\n\n"
            "1. DEMOGRAPHICS:\n   Age range, gender, location, education, income, profession\n\n"
            "2. PSYCHOGRAPHICS:\n   Values, interests, lifestyle, aspirations, goals\n\n"
            "3. PAIN POINTS:\n   Problems they're solving, frustrations with existing solutions, missing info\n\n"
            "4. CONTENT PREFERENCES:\n   Formats (video/text/audio), length, tone, consumption habits\n\n"
            "5. ENGAGEMENT TRIGGERS:\n   Discussion topics, emotional hooks, CTAs that work, community opportunities\n\n"
            "6. GROWTH OPPORTUNITIES:\n   Underserved sub-topics, cross-niche overlap, trending angles, collaboration potential\n\n"
            "RESEARCH METHODS:\n"
            "  - Survey existing audience\n  - Analyze competitor engagement\n"
            "  - Use platform analytics\n  - Join audience communities\n"
            "  - Monitor trending questions\n\n"
            "The built-in intelligence can provide deeper analysis."
        )
        self._aud_output.setText(output)
        self._set_result_summary(f"Audience analysis: {niche}.")

    def _run_platform_opt(self):
        platform = self._plat_name.currentText()
        content = self._plat_content.toPlainText().strip()
        if not content:
            self._plat_output.setText("Paste or describe your content first.")
            return
        task = f"Optimize this content for {platform}. Content: {content[:500]}. Include formatting, hashtags, hooks, best practices."
        sys_prompt = self._build_capability_prompt("Content Strategist", task, extra_context=f"Platform: {platform}")
        result = self._call_engine(sys_prompt, task, temperature=0.7)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._plat_output.setText(result)
            self._set_result_summary(f"Platform optimization: {platform}.")
            return
        guidelines = {
            "Blog/SEO": ["Title: keyword-rich, <60 chars", "Meta description: 150-160 chars", "Headers: H2/H3 with keywords", "Internal links: 3-5", "External links: 2-3 authoritative", "Images: compress + alt text", "Word count: 1,500-2,500", "Short paragraphs, bullets, bold key terms"],
            "YouTube": ["Title: <60 chars, keyword + hook", "Thumbnail: high contrast, expressive, minimal text", "Description: keywords in first 150 chars", "Tags: 5-10 relevant", "Chapters: timestamps for sections", "End screen: next video + subscribe", "Hook: first 15 seconds grab attention"],
            "Instagram": ["Caption: first 125 chars before 'more'", "Hashtags: 5-15, mix popular/niche", "Visual: consistent aesthetic", "Reels: 7-15s for max reach", "CTA: question or save/share prompt", "Carousel for educational content"],
            "LinkedIn": ["Hook: bold statement or question", "Short paragraphs, white space", "Professional, authentic tone", "3-5 hashtags", "Add image/document for 2x engagement", "CTA: specific question for comments", "Post Tue-Thu 8-10 AM"],
            "Twitter/X": ["Thread for complex topics, number each", "Hook tweet: bold claim or insight", "200-280 chars per tweet", "Add image/GIF for 3x engagement", "1-2 hashtags max", "Structure: hook → value → value → CTA"],
            "TikTok": ["Hook: first 3 seconds critical", "Length: 15-30s for best completion", "Bold, high-contrast captions", "Trending audio for reach", "Fast cuts every 2-3s", "3-5 hashtags including #fyp", "Post 1-3x daily"],
            "Email Newsletter": ["Subject: <50 chars, curiosity + benefit", "Preview text: complement subject", "Personalize with name", "One clear CTA", "Mobile-first design", "Keep above the fold valuable", "Test send times"],
            "Podcast": ["Episode title: descriptive + intriguing", "Show notes: summary + key points + links", "Chapter markers for sections", "Hook: tease value in first 30s", "Consistent format/structure", "Cross-promote on social"],
        }
        tips = guidelines.get(platform, guidelines["Blog/SEO"])
        output = f"[PLATFORM OPTIMIZATION — LOCAL]\n\nPlatform: {platform}\n\nOPTIMIZATION CHECKLIST:\n"
        for tip in tips:
            output += f"  - {tip}\n"
        output += f"\nYOUR CONTENT (first 200 chars):\n  {content[:200]}...\n\n"
        output += "The built-in intelligence can provide a fully optimized version."
        self._plat_output.setText(output)
        self._set_result_summary(f"Platform optimization: {platform}.")

    def _run_repurpose(self):
        original = self._repurpose_input.toPlainText().strip()
        if not original:
            self._repurpose_output.setText("Paste original content first.")
            return
        selected = [p for p, cb in self._repurpose_checks.items() if cb.isChecked()]
        if not selected:
            self._repurpose_output.setText("Select at least one target platform.")
            return
        task = f"Repurpose this content for: {', '.join(selected)}. Original: {original[:500]}. Adapt for each platform."
        sys_prompt = self._build_capability_prompt("Content Strategist", task, extra_context=f"Platforms: {', '.join(selected)}")
        result = self._call_engine(sys_prompt, task, temperature=0.7)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._repurpose_output.setText(result)
            self._set_result_summary(f"Repurposed for {len(selected)} platforms.")
            return
        templates = {
            "Twitter/X thread": "Break into 5-8 tweets. Tweet 1: bold hook. Tweets 2-N: one key point each with example. Final tweet: CTA + bookmark prompt.",
            "LinkedIn post": "Hook first line. 3-4 short paragraphs. Key takeaway as bullet points. End with question to drive comments.",
            "Instagram caption": "First line as hook. Condense to 3-5 key points with emojis. 5-10 relevant hashtags. CTA to save or share.",
            "TikTok script": "3-second visual hook. 15-30 second total. Speak key points fast. On-screen text for each point. CTA to follow.",
            "YouTube description": "First 150 chars with keywords. Summary of key points. Timestamps. Links to resources. Subscribe CTA.",
            "Email newsletter": "Subject line with curiosity. Personal greeting. Condensed key points. One clear CTA. P.S. with bonus tip.",
            "Blog summary": "SEO title. 300-500 word summary. H2 headers. Internal/external links. Featured image suggestion.",
        }
        output = f"[REPURPOSING — LOCAL]\n\nOriginal length: {len(original)} chars\nTarget platforms: {len(selected)}\n\n"
        for plat in selected:
            output += f"=== {plat.upper()} ===\n"
            output += f"Strategy: {templates.get(plat, 'Adapt content for this platform.')}\n"
            output += f"Source excerpt: {original[:150]}...\n\n"
        output += "REPURPOSING PRINCIPLES:\n  - Adapt, don't duplicate\n  - Match each platform's norms\n  - Keep core message consistent\n  - Optimize format for each audience\n\n"
        output += "The built-in intelligence can generate full repurposed content."
        self._repurpose_output.setText(output)
        self._set_result_summary(f"Repurposed for {len(selected)} platforms.")

    def _run_brand_voice(self):
        desc = self._brand_desc.toPlainText().strip()
        topic = self._brand_topic.text().strip() or "your topic"
        selected_tones = [t for t, cb in self._brand_checks.items() if cb.isChecked()]
        if not desc and not selected_tones:
            self._brand_output.setText("Describe your brand style or select tone attributes.")
            return
        tones_str = ", ".join(selected_tones) if selected_tones else "as described"
        task = f"Create a brand voice guide. Style: {desc or tones_str}. Tones: {tones_str}. Write a sample post about: {topic}."
        sys_prompt = self._build_capability_prompt("Content Strategist", task, extra_context=f"Tones: {tones_str}")
        result = self._call_engine(sys_prompt, task, temperature=0.8)
        if not result.startswith("[Backend") and not result.startswith("[Engine"):
            self._brand_output.setText(result)
            self._set_result_summary(f"Brand voice guide generated.")
            return
        output = (
            f"[BRAND VOICE GUIDE — LOCAL]\n\n"
            f"Style: {desc or 'Not specified'}\n"
            f"Tones: {tones_str}\n\n"
            "VOICE PRINCIPLES:\n"
            "  1. Consistency: Use the same voice across all platforms\n"
            "  2. Authenticity: Write as you speak, not as you think you should write\n"
            "  3. Audience-aware: Adjust complexity, not personality\n"
            "  4. Purposeful: Every piece should have a reason to exist\n\n"
            "VOICE ATTRIBUTES:\n"
        )
        ...
        output += (
            ...
            "  - Write conversationationally (read aloud test)\n"
            "  - Be specific, not generic\n"
            "  - Show personality through word choice and rhythm\n\n"
            "DON'T:\n"
            "  - Use jargon unless audience expects it\n"
            "  - Be overly formal if casual is your brand\n"
            "  - Copy competitors' voice\n"
            "  - Inconsistent tone between posts\n\n"
            f"SAMPLE POST (topic: {topic}):\n"
            f"  [Write using your defined voice attributes — the built-in intelligence\n"
            f"   can generate a full sample post in your brand voice.]\n\n"
            "VOICE CHECKLIST (before publishing):\n"
            "  - Does this sound like me/us?\n  - Is the tone consistent?\n"
            "  - Is it appropriate for the platform?\n  - Does it serve the audience?\n"
        )
        self._brand_output.setText(output)
        self._set_result_summary("Brand voice guide generated.")


class TaskSchedulerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Task Scheduler — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your scheduling needs:"))
        self._sched_input = QTextEdit()
        self._sched_input.setPlaceholderText("e.g., Schedule 3 meetings, block deep work time, set reminders for deadlines...")
        l.addWidget(self._sched_input)
        btn = QPushButton("Generate Schedule Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_schedule)
        l.addWidget(btn)
        self._sched_output = QTextEdit()
    ...
    def _run_schedule(self):
        ...
        if not task:
            self._sched_output.setText("Please describe your scheduling needs above.")
            return
        try:
            result = self._call_engine("You are a task scheduling assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a structured schedule plan.", 0.3)
            self._sched_output.setText(result)
            self._set_result_summary("Schedule plan generated.")
        except Exception as e:
            self._sched_output.setText(f"Error: {e}\n\nLocal fallback:\nTime blocking: identify priorities, estimate durations, block high-priority in peak hours, set reminders.")
            self._set_result_summary("Schedule plan generated (local fallback).")


class FormBuilderDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Form Builder — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the form or survey you need:"))
        self._form_input = QTextEdit()
        self._form_input.setPlaceholderText("e.g., Customer satisfaction survey, event registration form, feedback questionnaire...")
        l.addWidget(self._form_input)
        btn = QPushButton("Generate Form Design")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_form)
        l.addWidget(btn)
        self._form_output = QTextEdit()
    ...
    def _run_form(self):
        ...
        if not task:
            self._form_output.setText("Please describe the form you need above.")
            return
        try:
            result = self._call_engine("You are a form building assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a complete form design.", 0.4)
            self._form_output.setText(result)
            self._set_result_summary("Form design generated.")
        except Exception as e:
            self._form_output.setText(f"Error: {e}\n\nLocal fallback:\nDefine purpose, choose question types, structure logically, keep short, add validation.")
            self._set_result_summary("Form design generated (local fallback).")


class ReportGeneratorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Report Generator — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the report you need:"))
        self._report_input = QTextEdit()
        self._report_input.setPlaceholderText("e.g., Monthly sales report, project status update, performance analysis...")
        l.addWidget(self._report_input)
    ...
    def _run_report(self):
        ...
        if not task:
            self._report_output.setText("Please describe the report you need above.")
            return
        try:
            result = self._call_engine("You are a report generation assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a complete report structure.", 0.4)
            self._report_output.setText(result)
            self._set_result_summary("Report generated.")
        except Exception as e:
            self._report_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: Executive Summary, Background, Key Findings, Analysis, Recommendations, Appendices.")
            self._set_result_summary("Report generated (local fallback).")


class InvoiceProcessorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Invoice Processor — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the invoice you need:"))
        self._inv_input = QTextEdit()
        self._inv_input.setPlaceholderText("e.g., Invoice for web design services, $2500, Net 30, client: Acme Corp...")
        l.addWidget(self._inv_input)
        btn = QPushButton("Generate Invoice")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_invoice)
        l.addWidget(btn)
        self._inv_output = QTextEdit()
        self._inv_output.setReadOnly(True)
        l.addWidget(self._inv_output, stretch=1)
        layout.addLayout(l)
        footer = QLabel("Invoice Processor does NOT send invoices or process payments. Always verify calculations.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)

    def _run_invoice(self):
        task = self._inv_input.toPlainText().strip()
        if not task:
            self._inv_output.setText("Please describe the invoice details above.")
            return
        try:
            result = self._call_engine("You are an invoice processing assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a complete invoice.", 0.2)
            self._inv_output.setText(result)
            self._set_result_summary("Invoice generated.")
        except Exception as e:
            self._inv_output.setText(f"Error: {e}\n\nLocal fallback:\nInvoice: #, Date, Due Date, Bill To, Description/Qty/Rate/Amount, Subtotal, Tax, Total, Payment Terms.")
            self._set_result_summary("Invoice generated (local fallback).")


class SpreadsheetAnalystDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Spreadsheet Analyst — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your spreadsheet task:"))
        self._ss_input = QTextEdit()
        self._ss_input.setPlaceholderText("e.g., VLOOKUP formula, pivot table for sales data, calculate weighted averages...")
        l.addWidget(self._ss_input)
        btn = QPushButton("Get Spreadsheet Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_ss)
        l.addWidget(btn)
        self._ss_output = QTextEdit()
    ...
    def _run_ss(self):
        ...
        if not task:
            self._ss_output.setText("Please describe your spreadsheet task above.")
            return
        try:
            result = self._call_engine("You are a spreadsheet analysis assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide formulas and step-by-step instructions.", 0.3)
            self._ss_output.setText(result)
            self._set_result_summary("Spreadsheet guidance generated.")
        except Exception as e:
            self._ss_output.setText(f"Error: {e}\n\nLocal fallback:\nKey formulas: SUMIF, VLOOKUP/XLOOKUP, INDEX/MATCH, Pivot tables. Test on a copy first.")
            self._set_result_summary("Spreadsheet guidance generated (local fallback).")


class DataVisualizerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Data Visualizer — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your data and what you want to visualize:"))
        self._dv_input = QTextEdit()
        self._dv_input.setPlaceholderText("e.g., Monthly sales data for 5 products over 12 months, show trends and compare products...")
        l.addWidget(self._dv_input)
        btn = QPushButton("Get Visualization Recommendations")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_dv)
        l.addWidget(btn)
        self._dv_output = QTextEdit()
    ...
    def _run_dv(self):
        ...
        if not task:
            self._dv_output.setText("Please describe your data and visualization needs above.")
            return
        try:
            result = self._call_engine("You are a data visualization assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nRecommend the best visualizations with rationale.", 0.4)
            self._dv_output.setText(result)
            self._set_result_summary("Visualization recommendations generated.")
        except Exception as e:
            self._dv_output.setText(f"Error: {e}\n\nLocal fallback:\nComparison->Bar, Trend->Line, Composition->Pie/Stacked, Distribution->Histogram/Scatter, Relationship->Scatter/Heatmap.")
            self._set_result_summary("Visualization recommendations generated (local fallback).")


class StatisticalModelerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Statistical Modeler — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your statistical analysis needs:"))
        self._stat_input = QTextEdit()
        self._stat_input.setPlaceholderText("e.g., Regression analysis on housing prices, test if there is a significant difference between two groups...")
        l.addWidget(self._stat_input)
        btn = QPushButton("Get Statistical Analysis")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_stat)
        l.addWidget(btn)
        self._stat_output = QTextEdit()
        self._stat_output.setReadOnly(True)
        l.addWidget(self._stat_output, stretch=1)
        layout.addLayout(l)
        footer = QLabel("Statistical results require proper interpretation. Consult a statistician for critical decisions.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)

    def _run_stat(self):
        task = self._stat_input.toPlainText().strip()
        if not task:
            self._stat_output.setText("Please describe your statistical analysis needs above.")
            return
        try:
            result = self._call_engine("You are a statistical modeling assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide statistical analysis with method selection and interpretation.", 0.2)
            self._stat_output.setText(result)
            self._set_result_summary("Statistical analysis generated.")
        except Exception as e:
            self._stat_output.setText(f"Error: {e}\n\nLocal fallback:\nDefine H0/H1, check assumptions, choose test (t-test/ANOVA/regression/chi-square), report statistic/p-value/effect size/CI.")
            self._set_result_summary("Statistical analysis generated (local fallback).")


class TrendForecasterDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Trend Forecaster — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your data and what you want to forecast:"))
        self._fc_input = QTextEdit()
        self._fc_input.setPlaceholderText("e.g., 3 years of monthly revenue data, forecast the next 12 months...")
        l.addWidget(self._fc_input)
        btn = QPushButton("Generate Forecast")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_fc)
        l.addWidget(btn)
        self._fc_output = QTextEdit()
    ...
    def _run_fc(self):
        ...
        if not task:
            self._fc_output.setText("Please describe your forecasting needs above.")
            return
        try:
            result = self._call_engine("You are a trend forecasting assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a forecast with methodology and confidence intervals.", 0.3)
            self._fc_output.setText(result)
            self._set_result_summary("Forecast generated.")
        except Exception as e:
            self._fc_output.setText(f"Error: {e}\n\nLocal fallback:\nDecompose (trend/seasonality/noise), choose method (MA/Exponential smoothing/ARIMA), generate forecast with CIs, backtest.")
            self._set_result_summary("Forecast generated (local fallback).")


class DevOpsAssistantDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"DevOps Assistant — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your DevOps needs:"))
        self._devops_input = QTextEdit()
        self._devops_input.setPlaceholderText("e.g., Set up CI/CD pipeline for Python app, configure Docker for a microservice, write Kubernetes deployment manifest...")
        l.addWidget(self._devops_input)
        btn = QPushButton("Get DevOps Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_devops)
        l.addWidget(btn)
        self._devops_output = QTextEdit()
    ...
    def _run_devops(self):
        ...
        if not task:
            self._devops_output.setText("Please describe your DevOps needs above.")
            return
        try:
            result = self._call_engine("You are a DevOps assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide DevOps guidance with configuration examples.", 0.3)
            self._devops_output.setText(result)
            self._set_result_summary("DevOps guidance generated.")
        except Exception as e:
            self._devops_output.setText(f"Error: {e}\n\nLocal fallback:\nCI/CD: source->build->test->deploy. Use containers, IaC, automated testing, blue-green deploys, monitoring.")
            self._set_result_summary("DevOps guidance generated (local fallback).")


class DatabaseManagerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Database Manager — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your database task:"))
        self._db_input = QTextEdit()
        self._db_input.setPlaceholderText("e.g., Design a schema for an e-commerce app, optimize a slow query, write migration scripts...")
        l.addWidget(self._db_input)
        btn = QPushButton("Get Database Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_db)
        l.addWidget(btn)
        self._db_output = QTextEdit()
    ...
    def _run_db(self):
        ...
        if not task:
            self._db_output.setText("Please describe your database task above.")
            return
        try:
            result = self._call_engine("You are a database management assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide database guidance with schema design and query optimization.", 0.3)
            self._db_output.setText(result)
            self._set_result_summary("Database guidance generated.")
        except Exception as e:
            self._db_output.setText(f"Error: {e}\n\nLocal fallback:\nNormalize to 3NF, index foreign keys and frequent query columns, use EXPLAIN to analyze queries, backup before migrations.")
            self._set_result_summary("Database guidance generated (local fallback).")


class TestGeneratorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Test Generator — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the code you want tests for:"))
        self._test_input = QTextEdit()
        self._test_input.setPlaceholderText("e.g., Write unit tests for a Python function that validates email addresses, generate integration tests for a REST API endpoint...")
        l.addWidget(self._test_input)
        btn = QPushButton("Generate Tests")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
    ...
    def _run_test(self):
        ...
        if not task:
            self._test_output.setText("Please describe the code you want tests for above.")
            return
        try:
            result = self._call_engine("You are a test generation assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nGenerate comprehensive test cases with edge cases.", 0.3)
            self._test_output.setText(result)
            self._set_result_summary("Tests generated.")
        except Exception as e:
            self._test_output.setText(f"Error: {e}\n\nLocal fallback:\nTest types: unit, integration, edge cases, negative tests. Cover happy path, boundary values, error handling, null inputs.")
            self._set_result_summary("Tests generated (local fallback).")


class DocumentationGeneratorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Documentation Generator — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the documentation you need:"))
        self._doc_input = QTextEdit()
        self._doc_input.setPlaceholderText("e.g., Generate API docs for a REST endpoint, create a README for a Python project, write user guide for a CLI tool...")
        l.addWidget(self._doc_input)
        btn = QPushButton("Generate Documentation")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_doc)
        l.addWidget(btn)
        self._doc_output = QTextEdit()
        self._doc_output.setReadOnly(True)
    ...
    def _run_doc(self):
        ...
        if not task:
            self._doc_output.setText("Please describe the documentation you need above.")
            return
        try:
            result = self._call_engine("You are a documentation generation assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nGenerate clear, structured documentation.", 0.3)
            self._doc_output.setText(result)
            self._set_result_summary("Documentation generated.")
        except Exception as e:
            self._doc_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: Overview, Installation, Usage, API Reference, Examples, FAQ. Keep it clear and concise.")
            self._set_result_summary("Documentation generated (local fallback).")


class ScriptWriterDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Script Writer — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the script you need:"))
        self._script_input = QTextEdit()
        self._script_input.setPlaceholderText("e.g., Write a Python script to batch rename files, create a shell script for automated backups, write a PowerShell deployment script...")
        l.addWidget(self._script_input)
        btn = QPushButton("Generate Script")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_script)
        l.addWidget(btn)
    ...
    def _run_script(self):
        ...
        if not task:
            self._script_output.setText("Please describe the script you need above.")
            return
        try:
            result = self._call_engine("You are a script writing assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nGenerate a complete, well-commented script.", 0.3)
            self._script_output.setText(result)
            self._set_result_summary("Script generated.")
        except Exception as e:
            self._script_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: shebang, imports, args parsing, main logic, error handling, logging. Test in safe environment first.")
            self._set_result_summary("Script generated (local fallback).")


class CopyEditorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Copy Editor — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Paste the text you want edited:"))
        self._copy_input = QTextEdit()
        self._copy_input.setPlaceholderText("Paste your text here for grammar, style, and clarity improvements...")
        l.addWidget(self._copy_input)
        btn = QPushButton("Edit Copy")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_copy)
        l.addWidget(btn)
        self._copy_output = QTextEdit()
    ...
    def _run_copy(self):
        ...
        if not task:
            self._copy_output.setText("Please paste the text you want edited above.")
            return
        try:
            result = self._call_engine("You are a copy editing assistant.", f"AI: {self._ai_name}\nText: {task}\n\nProvide edited text with improvements noted.", 0.3)
            self._copy_output.setText(result)
            self._set_result_summary("Copy edited.")
        except Exception as e:
            self._copy_output.setText(f"Error: {e}\n\nLocal fallback:\nCheck: grammar, spelling, punctuation, consistency, clarity, conciseness, active voice, tone alignment.")
            self._set_result_summary("Copy edited (local fallback).")


class PodcastPlannerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Podcast Planner — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your podcast planning needs:"))
        self._pod_input = QTextEdit()
        self._pod_input.setPlaceholderText("e.g., Plan a 10-episode season on tech startups, create show notes for an interview episode, suggest segment structure...")
        l.addWidget(self._pod_input)
        btn = QPushButton("Generate Podcast Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_pod)
        l.addWidget(btn)
        self._pod_output = QTextEdit()
    ...
    def _run_pod(self):
        ...
        if not task:
            self._pod_output.setText("Please describe your podcast planning needs above.")
            return
        try:
            result = self._call_engine("You are a podcast planning assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a complete podcast plan with episodes, segments, and show notes.", 0.4)
            self._pod_output.setText(result)
            self._set_result_summary("Podcast plan generated.")
        except Exception as e:
            self._pod_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: Intro, main topic, guest segment, Q&A, closing. Plan 20-40 min episodes. Include show notes and timestamps.")
            self._set_result_summary("Podcast plan generated (local fallback).")


class BrandStrategistDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Brand Strategist — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your brand strategy needs:"))
        self._brand_strat_input = QTextEdit()
        self._brand_strat_input.setPlaceholderText("e.g., Develop a brand identity for a tech startup, create a brand positioning statement, define brand values and personality...")
        l.addWidget(self._brand_strat_input)
        btn = QPushButton("Generate Brand Strategy")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_brand_strat)
        l.addWidget(btn)
        self._brand_strat_output = QTextEdit()
    ...
    def _run_brand_strat(self):
        ...
        if not task:
            self._brand_strat_output.setText("Please describe your brand strategy needs above.")
            return
        try:
            result = self._call_engine("You are a brand strategy assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a comprehensive brand strategy with positioning, values, and personality.", 0.4)
            self._brand_strat_output.setText(result)
            self._set_result_summary("Brand strategy generated.")
        except Exception as e:
            self._brand_strat_output.setText(f"Error: {e}\n\nLocal fallback:\nBrand strategy: mission, vision, values, positioning, personality, voice, target audience, competitive analysis, visual identity.")
            self._set_result_summary("Brand strategy generated (local fallback).")


class PresentationCoachDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Presentation Coach — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your presentation:"))
        self._pres_input = QTextEdit()
        self._pres_input.setPlaceholderText("e.g., I need to present a quarterly report to executives, give a 15-minute talk on AI ethics, pitch a product to investors...")
        l.addWidget(self._pres_input)
        btn = QPushButton("Get Presentation Coaching")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_pres)
        l.addWidget(btn)
        self._pres_output = QTextEdit()
    ...
    def _run_pres(self):
        ...
        if not task:
            self._pres_output.setText("Please describe your presentation above.")
            return
        try:
            result = self._call_engine("You are a presentation coaching assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide presentation structure, talking points, and delivery tips.", 0.4)
            self._pres_output.setText(result)
            self._set_result_summary("Presentation coaching generated.")
        except Exception as e:
            self._pres_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: Hook, problem, solution, evidence, call to action. Practice timing, use visuals sparingly, engage audience.")
            self._set_result_summary("Presentation coaching generated (local fallback).")


class PRAssistantDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"PR Assistant — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your PR needs:"))
        self._pr_input = QTextEdit()
        self._pr_input.setPlaceholderText("e.g., Write a press release for a product launch, craft a crisis response statement, create a media pitch...")
        l.addWidget(self._pr_input)
        btn = QPushButton("Generate PR Content")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_pr)
        l.addWidget(btn)
        self._pr_output = QTextEdit()
    ...
    def _run_pr(self):
        ...
        if not task:
            self._pr_output.setText("Please describe your PR needs above.")
            return
        try:
            result = self._call_engine("You are a PR assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide PR content with proper format and tone.", 0.4)
            self._pr_output.setText(result)
            self._set_result_summary("PR content generated.")
        except Exception as e:
            self._pr_output.setText(f"Error: {e}\n\nLocal fallback:\nPress release: FOR IMMEDIATE RELEASE, headline, dateline, intro, body, quote, boilerplate, contact. Keep factual and newsworthy.")
            self._set_result_summary("PR content generated (local fallback).")


class InternalCommsWriterDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Internal Comms Writer — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the internal communication you need:"))
        self._ic_input = QTextEdit()
        self._ic_input.setPlaceholderText("e.g., Write a company-wide announcement about a new policy, draft a team update email, create a change management message...")
        l.addWidget(self._ic_input)
        btn = QPushButton("Generate Internal Comms")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_ic)
        l.addWidget(btn)
        self._ic_output = QTextEdit()
    ...
    def _run_ic(self):
        ...
        if not task:
            self._ic_output.setText("Please describe the internal communication you need above.")
            return
        try:
            result = self._call_engine("You are an internal communications assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide clear, professional internal communication.", 0.4)
            self._ic_output.setText(result)
            self._set_result_summary("Internal comms generated.")
        except Exception as e:
            self._ic_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: Context, what is changing, why, impact on team, next steps, Q&A contact. Keep clear and empathetic.")
            self._set_result_summary("Internal comms generated (local fallback).")


class AcademicCitationManagerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Academic Citation Manager — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your citation needs:"))
        self._cite_input = QTextEdit()
        self._cite_input.setPlaceholderText("e.g., Format citations in APA 7th edition, create a bibliography from these sources, convert MLA to Chicago style...")
        l.addWidget(self._cite_input)
        btn = QPushButton("Generate Citations")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_cite)
        l.addWidget(btn)
        self._cite_output = QTextEdit()
    ...
    def _run_cite(self):
        ...
        if not task:
            self._cite_output.setText("Please describe your citation needs above.")
            return
        try:
            result = self._call_engine("You are an academic citation assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide properly formatted citations in the requested style.", 0.2)
            self._cite_output.setText(result)
            self._set_result_summary("Citations generated.")
        except Exception as e:
            self._cite_output.setText(f"Error: {e}\n\nLocal fallback:\nVerify: author, title, date, publisher, pages, DOI/URL. Follow style guide exactly. Alphabetize bibliography.")
            self._set_result_summary("Citations generated (local fallback).")


class PatentResearcherDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Patent Researcher — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your patent research needs:"))
        self._patent_input = QTextEdit()
        self._patent_input.setPlaceholderText("e.g., Search for prior art on a new AI algorithm, analyze patent claims for a software invention, draft a patent abstract...")
        l.addWidget(self._patent_input)
        btn = QPushButton("Get Patent Research")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_patent)
        l.addWidget(btn)
        self._patent_output = QTextEdit()
        self._patent_output.setReadOnly(True)
        l.addWidget(self._patent_output, stretch=1)
        layout.addLayout(l)
        footer = QLabel("Patent research is informational only. Consult a patent attorney for legal advice.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)

    def _run_patent(self):
        task = self._patent_input.toPlainText().strip()
        if not task:
            self._patent_output.setText("Please describe your patent research needs above.")
            return
        try:
            result = self._call_engine("You are a patent research assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide patent research guidance with search strategies.", 0.3)
            self._patent_output.setText(result)
            self._set_result_summary("Patent research generated.")
        except Exception as e:
            self._patent_output.setText(f"Error: {e}\n\nLocal fallback:\nSearch: USPTO, Google Patents, WIPO. Keywords, CPC codes, inventor names. Review claims, not just abstracts.")
            self._set_result_summary("Patent research generated (local fallback).")


class MarketAnalystDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Market Analyst — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your market analysis needs:"))
        self._market_input = QTextEdit()
        self._market_input.setPlaceholderText("e.g., Analyze the SaaS market for small businesses, identify competitors in the fitness app space, assess market size for a new product...")
        l.addWidget(self._market_input)
        btn = QPushButton("Generate Market Analysis")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_market)
        l.addWidget(btn)
        self._market_output = QTextEdit()
    ...
    def _run_market(self):
        ...
        if not task:
            self._market_output.setText("Please describe your market analysis needs above.")
            return
        try:
            result = self._call_engine("You are a market analysis assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide market analysis with size, trends, competitors, and opportunities.", 0.4)
            self._market_output.setText(result)
            self._set_result_summary("Market analysis generated.")
        except Exception as e:
            self._market_output.setText(f"Error: {e}\n\nLocal fallback:\nAnalyze: TAM/SAM/SOM, growth rate, trends, competitors, SWOT, customer segments, barriers to entry.")
            self._set_result_summary("Market analysis generated (local fallback).")


class RecipePlannerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Recipe Planner — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your meal planning needs:"))
        self._recipe_input = QTextEdit()
        self._recipe_input.setPlaceholderText("e.g., Plan 5 dinners for a family of 4 with chicken and rice, suggest vegetarian meals under 30 minutes, create a weekly meal prep plan...")
        l.addWidget(self._recipe_input)
        btn = QPushButton("Generate Recipe Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_recipe)
        l.addWidget(btn)
        self._recipe_output = QTextEdit()
    ...
    def _run_recipe(self):
        ...
        if not task:
            self._recipe_output.setText("Please describe your meal planning needs above.")
            return
        try:
            result = self._call_engine("You are a recipe planning assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide recipes with ingredients, instructions, and prep tips.", 0.5)
            self._recipe_output.setText(result)
            self._set_result_summary("Recipe plan generated.")
        except Exception as e:
            self._recipe_output.setText(f"Error: {e}\n\nLocal fallback:\nPlan: protein, veg, starch, flavor. Batch cook staples. Prep ingredients ahead. Balance nutrition and variety.")
            self._set_result_summary("Recipe plan generated (local fallback).")


class TravelPlannerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Travel Planner — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your travel plans:"))
        self._travel_input = QTextEdit()
        self._travel_input.setPlaceholderText("e.g., Plan a 7-day trip to Japan, create an itinerary for a weekend in NYC, suggest budget travel options for Europe...")
        l.addWidget(self._travel_input)
        btn = QPushButton("Generate Travel Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_travel)
        l.addWidget(btn)
        self._travel_output = QTextEdit()
    ...
    def _run_travel(self):
        ...
        if not task:
            self._travel_output.setText("Please describe your travel plans above.")
            return
        try:
            result = self._call_engine("You are a travel planning assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a travel itinerary with activities, logistics, and tips.", 0.5)
            self._travel_output.setText(result)
            self._set_result_summary("Travel plan generated.")
        except Exception as e:
            self._travel_output.setText(f"Error: {e}\n\nLocal fallback:\nPlan: flights, accommodation, daily activities, transport, budget, packing list. Book in advance. Check visa requirements.")
            self._set_result_summary("Travel plan generated (local fallback).")


class EventPlannerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Event Planner — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe the event you are planning:"))
        self._event_input = QTextEdit()
        self._event_input.setPlaceholderText("e.g., Plan a corporate conference for 200 attendees, organize a birthday party for 30 people, create a webinar schedule...")
        l.addWidget(self._event_input)
        btn = QPushButton("Generate Event Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_event)
        l.addWidget(btn)
        self._event_output = QTextEdit()
    ...
    def _run_event(self):
        ...
        if not task:
            self._event_output.setText("Please describe the event you are planning above.")
            return
        try:
            result = self._call_engine("You are an event planning assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a complete event plan with timeline, logistics, and checklist.", 0.4)
            self._event_output.setText(result)
            self._set_result_summary("Event plan generated.")
        except Exception as e:
            self._event_output.setText(f"Error: {e}\n\nLocal fallback:\nPlan: venue, date, budget, guest list, catering, AV, timeline, invitations, contingency. Create a master checklist.")
            self._set_result_summary("Event plan generated (local fallback).")


class PersonalFinanceManagerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Personal Finance Manager — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your personal finance needs:"))
        self._finance_input = QTextEdit()
        self._finance_input.setPlaceholderText("e.g., Create a monthly budget, plan debt repayment strategy, suggest savings goals for the next year...")
        l.addWidget(self._finance_input)
        btn = QPushButton("Get Finance Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_finance)
        l.addWidget(btn)
        self._finance_output = QTextEdit()
        self._finance_output.setReadOnly(True)
        l.addWidget(self._finance_output, stretch=1)
        layout.addLayout(l)
        footer = QLabel("Personal Finance Manager provides general guidance only. Not financial advice. Consult a certified financial advisor.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)

    def _run_finance(self):
        task = self._finance_input.toPlainText().strip()
        if not task:
            self._finance_output.setText("Please describe your personal finance needs above.")
            return
        try:
            result = self._call_engine("You are a personal finance assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide budgeting and finance guidance.", 0.3)
            self._finance_output.setText(result)
            self._set_result_summary("Finance guidance generated.")
        except Exception as e:
            self._finance_output.setText(f"Error: {e}\n\nLocal fallback:\nBudget: 50/30/20 rule. Track income/expenses. Build emergency fund (3-6 months). Pay high-interest debt first. Automate savings.")
            self._set_result_summary("Finance guidance generated (local fallback).")


class PrivacyComplianceCheckerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Privacy Compliance Checker — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your privacy compliance needs:"))
        self._privacy_input = QTextEdit()
        self._privacy_input.setPlaceholderText("e.g., Check if my app is GDPR compliant, review privacy policy for CCPA requirements, assess data handling practices...")
        l.addWidget(self._privacy_input)
        btn = QPushButton("Get Compliance Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_privacy)
        l.addWidget(btn)
        self._privacy_output = QTextEdit()
        self._privacy_output.setReadOnly(True)
        l.addWidget(self._privacy_output, stretch=1)
        layout.addLayout(l)
        footer = QLabel("Privacy compliance guidance is informational only. Consult a legal professional for compliance certification.")
        footer.setStyleSheet("color: #ffab70; background-color: #4a2c00; padding: 6px; border-radius: 4px;")
        layout.addWidget(footer)

    def _run_privacy(self):
        task = self._privacy_input.toPlainText().strip()
        if not task:
            self._privacy_output.setText("Please describe your privacy compliance needs above.")
            return
        try:
            result = self._call_engine("You are a privacy compliance assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide compliance guidance with key requirements and gaps.", 0.2)
            self._privacy_output.setText(result)
            self._set_result_summary("Compliance guidance generated.")
        except Exception as e:
            self._privacy_output.setText(f"Error: {e}\n\nLocal fallback:\nCheck: data inventory, consent mechanisms, privacy policy, data subject rights, breach notification, data retention, cross-border transfers.")
            self._set_result_summary("Compliance guidance generated (local fallback).")


class DataGovernanceAdvisorDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Data Governance Advisor — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your data governance needs:"))
        self._gov_input = QTextEdit()
        self._gov_input.setPlaceholderText("e.g., Design a data governance framework, create data quality metrics, establish data stewardship roles...")
        l.addWidget(self._gov_input)
        btn = QPushButton("Get Governance Guidance")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_gov)
        l.addWidget(btn)
        self._gov_output = QTextEdit()
    ...
    def _run_gov(self):
        ...
        if not task:
            self._gov_output.setText("Please describe your data governance needs above.")
            return
        try:
            result = self._call_engine("You are a data governance advisor.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide data governance framework with policies, roles, and processes.", 0.3)
            self._gov_output.setText(result)
            self._set_result_summary("Governance guidance generated.")
        except Exception as e:
            self._gov_output.setText(f"Error: {e}\n\nLocal fallback:\nFramework: data policies, stewardship roles, quality metrics, lineage tracking, access controls, lifecycle management, audit trails.")
            self._set_result_summary("Governance guidance generated (local fallback).")


class CurriculumDesignerDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Curriculum Designer — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your curriculum design needs:"))
        self._curr_input = QTextEdit()
        self._curr_input.setPlaceholderText("e.g., Design a 12-week Python programming course, create a curriculum for high school biology, plan a corporate training program...")
        l.addWidget(self._curr_input)
        btn = QPushButton("Generate Curriculum")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_curr)
        l.addWidget(btn)
        self._curr_output = QTextEdit()
    ...
    def _run_curr(self):
        ...
        if not task:
            self._curr_output.setText("Please describe your curriculum design needs above.")
            return
        try:
            result = self._call_engine("You are a curriculum design assistant.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a structured curriculum with learning objectives, modules, and assessments.", 0.4)
            self._curr_output.setText(result)
            self._set_result_summary("Curriculum generated.")
        except Exception as e:
            self._curr_output.setText(f"Error: {e}\n\nLocal fallback:\nStructure: learning objectives, modules with outcomes, lessons, activities, assessments, prerequisites, progression.")
            self._set_result_summary("Curriculum generated (local fallback).")


class ExamPrepCoachDialog(BaseCapabilityDialog):
    def __init__(self, ai_name, ai_uuid, abilities, book_path=None, guardrails=None, libraries=None, use_case="", parent=None):
        super().__init__(ai_name, ai_uuid, abilities, book_path, guardrails, libraries, use_case, parent)
        self.setWindowTitle(f"Exam Prep Coach — {ai_name} | Avery Logic Works(TM)")
        self.resize(880, 660)
        layout = QVBoxLayout(self)
        banner = QLabel(self._build_context_banner())
        banner.setStyleSheet("color: #58a6ff; font-size: 11px; padding: 4px;")
        ...
        layout.addWidget(banner)
        l = QVBoxLayout()
        l.addWidget(QLabel("Describe your exam preparation needs:"))
        self._exam_input = QTextEdit()
        self._exam_input.setPlaceholderText("e.g., Prepare for the SAT in 3 months, study plan for the CCNA certification, practice questions for the bar exam...")
        l.addWidget(self._exam_input)
        btn = QPushButton("Generate Study Plan")
        btn.setStyleSheet("background-color: #1f6feb; color: white; font-weight: bold; padding: 8px;")
        btn.clicked.connect(self._run_exam)
        l.addWidget(btn)
        self._exam_output = QTextEdit()
    ...
    def _run_exam(self):
        ...
        if not task:
            self._exam_output.setText("Please describe your exam preparation needs above.")
            return
        try:
            result = self._call_engine("You are an exam preparation coach.", f"AI: {self._ai_name}\nTask: {task}\n\nProvide a study plan with schedule, topics, and practice strategies.", 0.4)
            self._exam_output.setText(result)
            self._set_result_summary("Study plan generated.")
        except Exception as e:
            self._exam_output.setText(f"Error: {e}\n\nLocal fallback:\nPlan: assess baseline, set target date, break topics into weeks, daily study blocks, practice tests weekly, review weak areas.")
            self._set_result_summary("Study plan generated (local fallback).")
