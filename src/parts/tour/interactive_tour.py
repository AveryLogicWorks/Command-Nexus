...
import math
from PyQt6.QtCore import Qt, QTimer, pyqtSignal, QPoint, QRect, QSize, QPropertyAnimation, QEasingCurve
from PyQt6.QtWidgets import (
    QDialog, QWidget, QVBoxLayout, QHBoxLayout, QLabel,
    QPushButton, QFrame, QGraphicsDropShadowEffect, QApplication,
    QMainWindow, QToolTip, QGraphicsOpacityEffect
)
from PyQt6.QtGui import QColor, QFont, QPainter, QPen, QBrush, QPolygon, QScreen, QCursor
