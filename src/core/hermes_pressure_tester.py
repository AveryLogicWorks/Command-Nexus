...
class HermesPressureTester:
    ...
    def test_edge_cases(self):
        ...
        try:
            ...
            if r1.status in (RuntimeStatus.COMPLETED, RuntimeStatus.PAUSED):
            ...
            if r2.status in (RuntimeStatus.COMPLETED, RuntimeStatus.PAUSED):
            ...
            if r3.status in (RuntimeStatus.COMPLETED, RuntimeStatus.PAUSED):
