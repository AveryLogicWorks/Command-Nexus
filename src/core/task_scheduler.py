...
class TaskScheduler(QObject):
    ...
    task_due = Signal(object)  # ScheduledTask
    task_completed = Signal(str, str)  # task_id, result_summary
    task_failed = Signal(str, str)  # task_id, error_msg
    task_missed = Signal(str)  # task_id
    approval_needed = Signal(object)  # ScheduledTask
    task_list_changed = Signal()
