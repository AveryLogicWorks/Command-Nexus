...
class NexusSettings:
    ...
    # Voice settings (all local, license-free)
    voice_mode: str = "push_to_talk"  # push_to_talk | wake_word | continuous
    voice_wake_word: str = "nexus"
    voice_tts_enabled: bool = False
    voice_tts_rate: int = 175
    voice_tts_volume: float = 1.0
    voice_tts_voice: str = ""
    voice_whisper_model_path: str = ""  # override default model path
    ...
    # Trial tracking — records when the 3-day FREE trial started
    trial_start_date: str = ""  # ISO datetime string

    # One-time beta disclaimer flag
    beta_disclaimer_shown: bool = False
